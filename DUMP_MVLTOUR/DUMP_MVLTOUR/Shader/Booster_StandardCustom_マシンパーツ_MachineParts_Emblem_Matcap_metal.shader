    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat33 = input.TEXCOORD6;
    u_xlat33 = clamp(u_xlat33, 0.0f, 1.0f);
    u_xlat3.xyz = fma(float3(u_xlat33), u_xlat3.xyz, float3(FGlobals.unity_FogColor.xyz));
    output.SV_Target0.xyz = half3(u_xlat3.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat5.x = dot(input.TEXCOORD2.xyz, float3(u_xlat16_3.xyz));
    u_xlat5.y = dot(input.TEXCOORD3.xyz, float3(u_xlat16_3.xyz));
    u_xlat5.z = dot(input.TEXCOORD4.xyz, float3(u_xlat16_3.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = u_xlat16_1.xyz * half3(u_xlat16_31);
    u_xlat4.xyz = fma(float3(u_xlat16_1.xyz), float3(u_xlat16_2.xyz), u_xlat5.xyw);
    u_xlat4.xyz = u_xlat4.xyz + (-float3(FGlobals.unity_FogColor.xyz));
    u_xlat34 = input.TEXCOORD6;
    u_xlat34 = clamp(u_xlat34, 0.0f, 1.0f);
    u_xlat4.xyz = fma(float3(u_xlat34), u_xlat4.xyz, float3(FGlobals.unity_FogColor.xyz));
    output.SV_Target0.xyz = half3(u_xlat4.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
