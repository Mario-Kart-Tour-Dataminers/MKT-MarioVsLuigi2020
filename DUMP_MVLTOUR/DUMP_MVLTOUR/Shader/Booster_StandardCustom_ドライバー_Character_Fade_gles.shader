...
void main()
{
    ...
    u_xlat10_3.x = texture2D(_TransparencyLM, vs_TEXCOORD0.zw).x;
...
void main()
{
    ...
    u_xlat36 = clamp(u_xlat36, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat36) * u_xlat16_0.xyz + unity_FogColor.xyz;
    u_xlat10_4.x = texture2D(_TransparencyLM, vs_TEXCOORD0.zw).x;
    u_xlat0.w = (-u_xlat10_4.x) + 1.0;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat33 = clamp(u_xlat33, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat33) * u_xlat0.xyz + unity_FogColor.xyz;
    u_xlat10_5.x = texture2D(_TransparencyLM, vs_TEXCOORD0.zw).x;
    u_xlat0.w = (-u_xlat10_5.x) + 1.0;
    SV_Target0 = u_xlat0;
    return;
}
