    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    output.mtl_Position.z = u_xlat0.w * u_xlat4;
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    output.mtl_Position.z = u_xlat0.w * u_xlat1.x;
    output.mtl_Position.xyw = u_xlat0.xyw;
    u_xlat0.x = u_xlat0.z / VGlobals._ProjectionParams.y;
    u_xlat0.x = (-u_xlat0.x) + 1.0;
    u_xlat0.x = u_xlat0.x * VGlobals._ProjectionParams.z;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    Mtl_FragmentOut output;
    float3 u_xlat0;
    u_xlat0.xyz = input.COLOR0.xyz * float3(FGlobals._Color.xyz);
    output.SV_Target0.xyz = half3(u_xlat0.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.x = input.TEXCOORD0;
    u_xlat0.x = clamp(u_xlat0.x, 0.0f, 1.0f);
    u_xlat1.xyz = fma(float3(FGlobals._Color.xyz), input.COLOR0.xyz, (-float3(FGlobals.unity_FogColor.xyz)));
