    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    output.TEXCOORD1.zw = fma(input.TEXCOORD0.xy, VGlobals._SphereMapMask_ST.xy, VGlobals._SphereMapMask_ST.zw);
    output.TEXCOORD2.xy = fma(input.TEXCOORD1.xy, VGlobals._Decal_ST.xy, VGlobals._Decal_ST.zw);
    output.TEXCOORD2.zw = fma(input.TEXCOORD0.xy, VGlobals._EmissionMap_ST.xy, VGlobals._EmissionMap_ST.zw);
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    output.TEXCOORD7 = max(u_xlat15, float(u_xlat16_4));
    output.TEXCOORD8 = float4(0.0, 0.0, 0.0, 0.0);
    return output;
}
"
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    output.TEXCOORD6.xyz = fma(VGlobals.unity_SHC.xyz, half3(u_xlat16_4), u_xlat16_5.xyz);
    u_xlat16_4 = (-VGlobals.unity_FogColor.w) + half(1.0);
    output.TEXCOORD7 = max(u_xlat18, float(u_xlat16_4));
    output.TEXCOORD8 = float4(0.0, 0.0, 0.0, 0.0);
    return output;
}
"
...
fragment Mtl_FragmentOut xlatMtlMain(
    ...
    texture2d<half, access::sample > _SphereMap [[ texture(5) ]] ,
    texture2d<half, access::sample > _SphereMapMask [[ texture(6) ]] ,
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat1.x = dot(input.TEXCOORD3.xyz, float3(u_xlat16_2.xyz));
    u_xlat1.y = dot(input.TEXCOORD4.xyz, float3(u_xlat16_2.xyz));
    u_xlat1.z = dot(input.TEXCOORD5.xyz, float3(u_xlat16_2.xyz));
    ...
    u_xlat16_7.xyz = u_xlat16_1.xyz * FGlobals._SphereMapScale.xyz;
    u_xlat16_1.xyz = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xy).xyz;
    u_xlat16_8.xyz = fma(FGlobals._Color.xyz, u_xlat16_1.xyz, FGlobals._AddColor.xyz);
    u_xlat16_1 = _Decal.sample(sampler_Decal, input.TEXCOORD2.xy);
    u_xlat16_1 = fma(u_xlat16_1, FGlobals._Color, FGlobals._AddColor);
    u_xlat16_9.xyz = (-u_xlat16_8.xyz) + u_xlat16_1.xyz;
    u_xlat16_8.xyz = fma(u_xlat16_1.www, u_xlat16_9.xyz, u_xlat16_8.xyz);
    u_xlat16_4.xyz = _SphereMapMask.sample(sampler_SphereMapMask, input.TEXCOORD1.zw).xyz;
    u_xlat16_7.xyz = fma(u_xlat16_7.xyz, u_xlat16_4.xyz, u_xlat16_8.xyz);
    ...
    u_xlat16_2.x = half((-u_xlat36) + 1.0);
    ...
    u_xlat16_0.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.zw).xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = u_xlat16_11.xyz * FGlobals._SphereMapScale.xyz;
    u_xlat16_11.xyz = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xy).xyz;
    u_xlat16_8.xyz = fma(FGlobals._Color.xyz, u_xlat16_11.xyz, FGlobals._AddColor.xyz);
    u_xlat16_2 = _Decal.sample(sampler_Decal, input.TEXCOORD2.xy);
    u_xlat16_2 = fma(u_xlat16_2, FGlobals._Color, FGlobals._AddColor);
    u_xlat16_9.xyz = (-u_xlat16_8.xyz) + u_xlat16_2.xyz;
    u_xlat16_8.xyz = fma(u_xlat16_2.www, u_xlat16_9.xyz, u_xlat16_8.xyz);
    u_xlat16_11.xyz = _SphereMapMask.sample(sampler_SphereMapMask, input.TEXCOORD1.zw).xyz;
    u_xlat16_7.xyz = fma(u_xlat16_7.xyz, u_xlat16_11.xyz, u_xlat16_8.xyz);
    u_xlat16_8.xyz = u_xlat16_7.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    ...
    u_xlat16_1.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.zw).xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0 = _Decal.sample(sampler_Decal, input.TEXCOORD2.xy);
    u_xlat16_0 = fma(u_xlat16_0, FGlobals._Color, FGlobals._AddColor);
    u_xlat16_2.xyz = (-u_xlat16_1.xyz) + u_xlat16_0.xyz;
    u_xlat16_1.xyz = fma(u_xlat16_0.www, u_xlat16_2.xyz, u_xlat16_1.xyz);
    ...
    u_xlat4.x = dot(input.TEXCOORD3.xyz, float3(u_xlat16_2.xyz));
    u_xlat4.y = dot(input.TEXCOORD4.xyz, float3(u_xlat16_2.xyz));
    u_xlat4.z = dot(input.TEXCOORD5.xyz, float3(u_xlat16_2.xyz));
    ...
    u_xlat16_2.xyz = u_xlat16_3.xyz * FGlobals._SphereMapScale.xyz;
    u_xlat16_3.xyz = _SphereMapMask.sample(sampler_SphereMapMask, input.TEXCOORD1.zw).xyz;
    ...
    u_xlat16_2.xyz = max(u_xlat16_3.xyz, FGlobals._MinMSA.xyz);
    u_xlat16_31 = fma((-u_xlat16_2.x), half(0.779083729), half(0.779083729));
    u_xlat16_5.xyz = half3(u_xlat16_31) * u_xlat16_1.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_1.xyz = fma(u_xlat16_2.xxx, u_xlat16_1.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_31 = (-u_xlat16_31) + u_xlat16_2.y;
    u_xlat16_31 = u_xlat16_31 + half(1.0);
    u_xlat16_31 = clamp(u_xlat16_31, 0.0h, 1.0h);
    u_xlat16_6.xyz = (-u_xlat16_1.xyz) + half3(u_xlat16_31);
    ...
    u_xlat8.xyz = fma(u_xlat4.xyz, u_xlat13.xxx, float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat4.xyw = fma(u_xlat4.xxx, float3(u_xlat16_1.xyz), float3(u_xlat16_5.xyz));
    ...
    u_xlat4.xyw = fma(u_xlat4.xyw, u_xlat8.xxx, float3(u_xlat16_7.xyz));
    u_xlat16_2.x = dot((-u_xlat13.xyz), u_xlat0.xyz);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat16_2.xyw = half3(fma(u_xlat0.xyz, (-float3(u_xlat16_2.xxx)), (-u_xlat13.xyz)));
    u_xlat13.x = dot(u_xlat0.xyz, u_xlat13.xyz);
    u_xlat13.x = clamp(u_xlat13.x, 0.0f, 1.0f);
    u_xlat16_5.x = half((-u_xlat13.x) + 1.0);
    u_xlat16_5.x = u_xlat16_5.x * u_xlat16_5.x;
    u_xlat16_5.x = u_xlat16_5.x * u_xlat16_5.x;
    u_xlat16_1.xyz = fma(u_xlat16_5.xxx, u_xlat16_6.xyz, u_xlat16_1.xyz);
    u_xlat13.x = dot(u_xlat16_2.wxy, (-u_xlat16_2.xyw));
    u_xlatb13 = u_xlat13.x<9.99999975e-06;
    u_xlat13.x = (u_xlatb13) ? float(u_xlat16_2.w) : (-float(u_xlat16_2.w));
    u_xlat8.z = float(u_xlat16_2.x) * u_xlat13.x;
    u_xlat9.x = float(u_xlat16_2.w) * u_xlat13.x;
    u_xlat8.xy = (-float2(u_xlat16_2.xy)) * float2(u_xlat16_2.yw);
    ...
    u_xlat13.xyz = u_xlat13.xyz * float3(FGlobals._NormalDiff);
    u_xlat3.xyz = fma(u_xlat13.xyz, u_xlat3.xxx, float3(u_xlat16_2.xyw));
    u_xlat33 = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat33 = rsqrt(u_xlat33);
    u_xlat3.xyz = float3(u_xlat33) * u_xlat3.xyz;
    u_xlatb33 = u_xlat24<0.00499999989;
    u_xlat24 = u_xlat24 * 8.29800034;
    u_xlat16_2.x = (u_xlatb33) ? half(0.0) : half(u_xlat24);
    u_xlat16_0 = unity_SpecCube0.sample(samplerunity_SpecCube0, u_xlat3.xyz, bias(float(u_xlat16_2.x)));
    ...
    u_xlat3.xyz = fma(float3(u_xlat16_2.xyz), float3(u_xlat16_1.xyz), u_xlat4.xyw);
    u_xlat16_4.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * FGlobals._Emission.xxyz.yzw;
    output.SV_Target0.xyz = half3(fma(float3(u_xlat16_4.xyz), float3(FGlobals._EmissionIntensity), u_xlat3.xyz));
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = u_xlat16_6.xyz + input.TEXCOORD6.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.x = dot(u_xlat16_5, FGlobals.unity_OcclusionMaskSelector);
    u_xlat16_2.x = clamp(u_xlat16_2.x, 0.0h, 1.0h);
    u_xlat16_2.xyw = u_xlat16_2.xxx * FGlobals._LightColor0.xyz;
    u_xlat4.xyw = float3(u_xlat16_2.xyw) * u_xlat4.xyw;
    u_xlat8.x = dot(u_xlat0.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat8.x = clamp(u_xlat8.x, 0.0f, 1.0f);
    u_xlat4.xyw = fma(u_xlat4.xyw, u_xlat8.xxx, float3(u_xlat16_7.xyz));
    u_xlat16_2.x = dot((-u_xlat13.xyz), u_xlat0.xyz);
    ...
    u_xlat13.x = dot(u_xlat0.xyz, u_xlat13.xyz);
    u_xlat13.x = clamp(u_xlat13.x, 0.0f, 1.0f);
    u_xlat16_36 = half((-u_xlat13.x) + 1.0);
    u_xlat16_36 = u_xlat16_36 * u_xlat16_36;
    u_xlat16_36 = u_xlat16_36 * u_xlat16_36;
    u_xlat16_1.xyz = fma(half3(u_xlat16_36), u_xlat16_6.xyz, u_xlat16_1.xyz);
    u_xlat13.x = dot(u_xlat16_2.wxy, (-u_xlat16_2.xyw));
    u_xlatb13 = u_xlat13.x<9.99999975e-06;
    u_xlat13.x = (u_xlatb13) ? float(u_xlat16_2.w) : (-float(u_xlat16_2.w));
    u_xlat8.z = float(u_xlat16_2.x) * u_xlat13.x;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_4.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * FGlobals._Emission.xxyz.yzw;
    u_xlat16_1.xyz = half3(fma(float3(u_xlat16_4.xyz), float3(FGlobals._EmissionIntensity), u_xlat3.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = _MSA.sample(sampler_MSA, input.TEXCOORD1.xy).xyz;
    u_xlat16_5.xyz = max(u_xlat16_3.xyz, FGlobals._MinMSA.xyz);
    u_xlat16_2.xyz = fma(u_xlat16_5.xxx, u_xlat16_2.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    ...
    u_xlat7.xyz = (-u_xlat4.xyz) + FGlobals._WorldSpaceCameraPos.xyzx.xyz;
    u_xlat30 = dot(u_xlat4.xyz, FGlobals._NormalRand.xyz);
    u_xlat30 = sin(u_xlat30);
    u_xlat30 = u_xlat30 * FGlobals._NormalRand.w;
    u_xlat30 = fract(u_xlat30);
    u_xlat4.x = dot(u_xlat7.xyz, u_xlat7.xyz);
    u_xlat4.x = rsqrt(u_xlat4.x);
    u_xlat13.xyz = fma(u_xlat7.xyz, u_xlat4.xxx, float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat34 = fma(u_xlat31, u_xlat31, -1.0);
    u_xlat13.x = fma(u_xlat13.x, u_xlat34, 1.00001001);
    ...
    u_xlat4.x = max(u_xlat4.x, 0.0);
    u_xlat4.x = min(u_xlat4.x, 100.0);
    u_xlat4.xyw = fma(u_xlat4.xxx, float3(u_xlat16_2.xyz), float3(u_xlat16_1.xyz));
    u_xlat4.xyw = u_xlat4.xyw * float3(FGlobals._LightColor0.xyz);
    u_xlat16_8.xyz = unity_Lightmap.sample(samplerunity_Lightmap, input.TEXCOORD6.xy).xyz;
    u_xlat16_5.xyw = u_xlat16_8.xyz * FGlobals.unity_Lightmap_HDR.xxx;
    u_xlat16_5.xyw = u_xlat16_5.zzz * u_xlat16_5.xyw;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_5.xyw;
    u_xlat34 = dot(u_xlat3.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat34 = clamp(u_xlat34, 0.0f, 1.0f);
    u_xlat4.xyw = fma(u_xlat4.xyw, float3(u_xlat34), float3(u_xlat16_1.xyz));
    u_xlat16_1.x = dot((-u_xlat7.xyz), u_xlat3.xyz);
    u_xlat16_1.x = u_xlat16_1.x + u_xlat16_1.x;
    u_xlat16_1.xyz = half3(fma(u_xlat3.xyz, (-float3(u_xlat16_1.xxx)), (-u_xlat7.xyz)));
    u_xlat3.x = dot(u_xlat3.xyz, u_xlat7.xyz);
    u_xlat3.x = clamp(u_xlat3.x, 0.0f, 1.0f);
    u_xlat16_29 = half((-u_xlat3.x) + 1.0);
    u_xlat16_29 = u_xlat16_29 * u_xlat16_29;
    u_xlat16_29 = u_xlat16_29 * u_xlat16_29;
    u_xlat16_2.xyz = fma(half3(u_xlat16_29), u_xlat16_6.xyz, u_xlat16_2.xyz);
    ...
    u_xlat7.z = float(u_xlat16_1.x) * u_xlat3.x;
    ...
    u_xlat16_1.x = (u_xlatb30) ? half(0.0) : half(u_xlat22);
    u_xlat16_0 = unity_SpecCube0.sample(samplerunity_SpecCube0, u_xlat3.xyz, bias(float(u_xlat16_1.x)));
    ...
    u_xlat3.xyz = fma(float3(u_xlat16_1.xyz), float3(u_xlat16_2.xyz), u_xlat4.xyw);
    u_xlat16_4.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * FGlobals._Emission.xxyz.yzw;
    output.SV_Target0.xyz = half3(fma(float3(u_xlat16_4.xyz), float3(FGlobals._EmissionIntensity), u_xlat3.xyz));
    output.SV_Target0.w = half(1.0);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_9.xyz = half3(fma(u_xlat0.xxx, float3(u_xlat16_8.xyz), float3(u_xlat16_7.xyz)));
    u_xlat16_39 = half((-u_xlat4.x) + 1.0);
    u_xlat16_0.x = u_xlat16_39 * u_xlat16_39;
    u_xlat16_0.x = u_xlat16_39 * u_xlat16_0.x;
    u_xlat16_0.x = u_xlat16_39 * u_xlat16_0.x;
    u_xlat16_3.xyw = fma(u_xlat16_0.xxx, u_xlat16_3.xyw, u_xlat16_8.xyz);
    ...
    u_xlat16_6.xyz = fma(FGlobals.unity_Lightmap_HDR.xxx, u_xlat16_5.xyz, u_xlat16_4.xyz);
    u_xlat16_6.xyz = u_xlat16_3.zzz * u_xlat16_6.xyz;
    u_xlat16_3.xyz = fma(u_xlat16_6.xyz, u_xlat16_7.xyz, u_xlat16_3.xyw);
    u_xlat16_3.xyz = fma(u_xlat16_9.xyz, u_xlat16_8.xyz, u_xlat16_3.xyz);
    u_xlat16_4.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * FGlobals._Emission.xxyz.yzw;
    output.SV_Target0.xyz = fma(u_xlat16_4.xyz, half3(FGlobals._EmissionIntensity), u_xlat16_3.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0.xyz = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xy).xyz;
    u_xlat16_7.xyz = fma(FGlobals._Color.xyz, u_xlat16_0.xyz, FGlobals._AddColor.xyz);
    u_xlat16_0 = _Decal.sample(sampler_Decal, input.TEXCOORD2.xy);
    u_xlat16_0 = fma(u_xlat16_0, FGlobals._Color, FGlobals._AddColor);
    u_xlat16_8.xyz = (-u_xlat16_7.xyz) + u_xlat16_0.xyz;
    u_xlat16_7.xyz = fma(u_xlat16_0.www, u_xlat16_8.xyz, u_xlat16_7.xyz);
    u_xlat16_5.xyz = _SphereMapMask.sample(sampler_SphereMapMask, input.TEXCOORD1.zw).xyz;
    u_xlat16_4.xyz = fma(u_xlat16_4.xyz, u_xlat16_5.xyz, u_xlat16_7.xyz);
    u_xlat16_35 = fma((-u_xlat16_3.x), half(0.779083729), half(0.779083729));
    u_xlat16_7.xyz = half3(u_xlat16_35) * u_xlat16_4.xyz;
    ...
    u_xlat16_8.xyz = (-u_xlat16_4.xyz) + half3(u_xlat16_35);
    ...
    u_xlat9.xyz = fma(u_xlat6.xyz, u_xlat16.xxx, float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat28 = (-float(u_xlat16_3.y)) + 1.0;
    u_xlat39 = u_xlat28 * u_xlat28;
    u_xlat9.x = fma(u_xlat39, u_xlat39, -1.0);
    u_xlat17 = fma(u_xlat17, u_xlat9.x, 1.00001001);
    u_xlat9.x = fma(u_xlat28, u_xlat28, 1.5);
    u_xlat6.x = u_xlat6.x * u_xlat9.x;
    u_xlat6.x = u_xlat17 * u_xlat6.x;
    u_xlat6.x = u_xlat39 / u_xlat6.x;
    u_xlat16_35 = half(u_xlat28 * u_xlat39);
    ...
    u_xlat6.xyw = fma(u_xlat6.xxx, float3(u_xlat16_4.xyz), float3(u_xlat16_7.xyz));
    u_xlat6.xyw = u_xlat6.xyw * float3(FGlobals._LightColor0.xyz);
    u_xlat9.x = dot(u_xlat1.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat9.x = clamp(u_xlat9.x, 0.0f, 1.0f);
    u_xlat6.xyw = fma(u_xlat6.xyw, u_xlat9.xxx, float3(u_xlat16_2.xyz));
    u_xlat16_2.x = dot((-u_xlat16.xyz), u_xlat1.xyz);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat16_2.xyz = half3(fma(u_xlat1.xyz, (-float3(u_xlat16_2.xxx)), (-u_xlat16.xyz)));
    u_xlat16.x = dot(u_xlat1.xyz, u_xlat16.xyz);
    u_xlat16.x = clamp(u_xlat16.x, 0.0f, 1.0f);
    u_xlat16_3.x = half((-u_xlat16.x) + 1.0);
    u_xlat16_3.x = u_xlat16_3.x * u_xlat16_3.x;
    u_xlat16_3.x = u_xlat16_3.x * u_xlat16_3.x;
    ...
    u_xlat16.x = (u_xlatb16) ? float(u_xlat16_2.z) : (-float(u_xlat16_2.z));
    u_xlat9.z = float(u_xlat16_2.x) * u_xlat16.x;
    u_xlat10.x = float(u_xlat16_2.z) * u_xlat16.x;
    u_xlat9.xy = (-float2(u_xlat16_2.xy)) * float2(u_xlat16_2.yz);
    ...
    u_xlat16.xyz = u_xlat16.xyz * float3(FGlobals._NormalDiff);
    u_xlat5.xyz = fma(u_xlat16.xyz, u_xlat5.xxx, float3(u_xlat16_2.xyz));
    u_xlat38 = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat38 = rsqrt(u_xlat38);
    u_xlat5.xyz = float3(u_xlat38) * u_xlat5.xyz;
    u_xlatb38 = u_xlat28<0.00499999989;
    u_xlat28 = u_xlat28 * 8.29800034;
    u_xlat16_2.x = (u_xlatb38) ? half(0.0) : half(u_xlat28);
    u_xlat16_0 = unity_SpecCube0.sample(samplerunity_SpecCube0, u_xlat5.xyz, bias(float(u_xlat16_2.x)));
    u_xlat16_2.x = u_xlat16_0.w + half(-1.0);
    u_xlat16_2.x = fma(FGlobals.unity_SpecCube0_HDR.w, u_xlat16_2.x, half(1.0));
    u_xlat16_2.x = u_xlat16_2.x * FGlobals.unity_SpecCube0_HDR.x;
    ...
    u_xlat5.xyz = fma(float3(u_xlat16_2.xyz), float3(u_xlat16_3.xyw), u_xlat6.xyw);
    u_xlat16_6.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.zw).xyz;
    u_xlat16_6.xyz = u_xlat16_6.xyz * FGlobals._Emission.xxyz.yzw;
    output.SV_Target0.xyz = half3(fma(float3(u_xlat16_6.xyz), float3(FGlobals._EmissionIntensity), u_xlat5.xyz));
    output.SV_Target0.w = half(1.0);
    return output;
}
"
...
fragment Mtl_FragmentOut xlatMtlMain(
    ...
    sampler sampler_SphereMap [[ sampler (9) ]],
    sampler sampler_SphereMapMask [[ sampler (10) ]],
    texture2d<half, access::sample > _MainTex [[ texture(0) ]] ,
    texture2d<half, access::sample > _Decal [[ texture(1) ]] ,
    texture2d<half, access::sample > _MSA [[ texture(2) ]] ,
    texture2d<half, access::sample > _BumpMap [[ texture(3) ]] ,
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = fma(u_xlat16_0.www, u_xlat16_3.xyz, u_xlat16_2.xyz);
    u_xlat4.x = FGlobals.hlslcc_mtx4x4unity_MatrixV[0].x;
    u_xlat4.y = FGlobals.hlslcc_mtx4x4unity_MatrixV[1].x;
    u_xlat4.z = FGlobals.hlslcc_mtx4x4unity_MatrixV[2].x;
    ...
    u_xlat5.x = dot(input.TEXCOORD3.xyz, float3(u_xlat16_3.xyz));
    u_xlat5.y = dot(input.TEXCOORD4.xyz, float3(u_xlat16_3.xyz));
    u_xlat5.z = dot(input.TEXCOORD5.xyz, float3(u_xlat16_3.xyz));
    ...
    u_xlat16_4.xyz = _SphereMap.sample(sampler_SphereMap, float2(u_xlat16_3.xy)).xyz;
    u_xlat16_3.xyz = u_xlat16_4.xyz * FGlobals._SphereMapScale.xyz;
    u_xlat16_4.xyz = _SphereMapMask.sample(sampler_SphereMapMask, input.TEXCOORD1.zw).xyz;
    ...
    u_xlat16_6.xyz = max(u_xlat16_4.xyz, FGlobals._MinMSA.xyz);
    u_xlat16_3.xyz = fma(u_xlat16_6.xxx, u_xlat16_3.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_31 = fma((-u_xlat16_6.x), half(0.779083729), half(0.779083729));
    u_xlat16_2.xyz = half3(u_xlat16_31) * u_xlat16_2.xyz;
    ...
    u_xlat34 = dot(u_xlat5.xyz, FGlobals._NormalRand.xyz);
    u_xlat34 = sin(u_xlat34);
    u_xlat34 = u_xlat34 * FGlobals._NormalRand.w;
    u_xlat34 = fract(u_xlat34);
    u_xlat5.x = dot(u_xlat8.xyz, u_xlat8.xyz);
    u_xlat5.x = rsqrt(u_xlat5.x);
    u_xlat15.xyz = fma(u_xlat8.xyz, u_xlat5.xxx, float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat25 = (-float(u_xlat16_6.y)) + 1.0;
    u_xlat35 = u_xlat25 * u_xlat25;
    u_xlat38 = fma(u_xlat35, u_xlat35, -1.0);
    u_xlat15.x = fma(u_xlat15.x, u_xlat38, 1.00001001);
    u_xlat38 = fma(u_xlat25, u_xlat25, 1.5);
    ...
    u_xlat5.xyw = fma(u_xlat5.xxx, float3(u_xlat16_3.xyz), float3(u_xlat16_2.xyz));
    u_xlat5.xyw = float3(u_xlat16_1.xyz) * u_xlat5.xyw;
    u_xlat16_9.xyz = unity_Lightmap.sample(samplerunity_Lightmap, input.TEXCOORD6.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_9.xyz * FGlobals.unity_Lightmap_HDR.xxx;
    ...
    u_xlat5.xyw = fma(u_xlat5.xyw, float3(u_xlat38), float3(u_xlat16_1.xyz));
    u_xlat16_1.x = dot((-u_xlat8.xyz), u_xlat4.xyz);
    u_xlat16_1.x = u_xlat16_1.x + u_xlat16_1.x;
    u_xlat16_1.xyz = half3(fma(u_xlat4.xyz, (-float3(u_xlat16_1.xxx)), (-u_xlat8.xyz)));
    u_xlat4.x = dot(u_xlat4.xyz, u_xlat8.xyz);
    u_xlat4.x = clamp(u_xlat4.x, 0.0f, 1.0f);
    u_xlat16_2.x = half((-u_xlat4.x) + 1.0);
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat16_2.xyz = fma(u_xlat16_2.xxx, u_xlat16_7.xyz, u_xlat16_3.xyz);
    u_xlat4.x = dot(u_xlat16_1.zxy, (-u_xlat16_1.xyz));
    u_xlatb4 = u_xlat4.x<9.99999975e-06;
    u_xlat4.x = (u_xlatb4) ? float(u_xlat16_1.z) : (-float(u_xlat16_1.z));
    u_xlat8.z = float(u_xlat16_1.x) * u_xlat4.x;
    u_xlat4.x = float(u_xlat16_1.z) * u_xlat4.x;
    u_xlat8.xy = (-float2(u_xlat16_1.xy)) * float2(u_xlat16_1.yz);
    ...
    u_xlat4.xyz = u_xlat4.xyz * float3(FGlobals._NormalDiff);
    u_xlat4.xyz = fma(u_xlat4.xyz, float3(u_xlat34), float3(u_xlat16_1.xyz));
    u_xlat34 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat34 = rsqrt(u_xlat34);
    u_xlat4.xyz = float3(u_xlat34) * u_xlat4.xyz;
    u_xlatb34 = u_xlat25<0.00499999989;
    u_xlat25 = u_xlat25 * 8.29800034;
    u_xlat16_1.x = (u_xlatb34) ? half(0.0) : half(u_xlat25);
    u_xlat16_0 = unity_SpecCube0.sample(samplerunity_SpecCube0, u_xlat4.xyz, bias(float(u_xlat16_1.x)));
    u_xlat16_1.x = u_xlat16_0.w + half(-1.0);
    u_xlat16_1.x = fma(FGlobals.unity_SpecCube0_HDR.w, u_xlat16_1.x, half(1.0));
    u_xlat16_1.x = u_xlat16_1.x * FGlobals.unity_SpecCube0_HDR.x;
    u_xlat16_1.xyz = u_xlat16_0.xyz * u_xlat16_1.xxx;
    ...
    u_xlat4.xyz = fma(float3(u_xlat16_1.xyz), float3(u_xlat16_2.xyz), u_xlat5.xyw);
    u_xlat16_5.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.zw).xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * FGlobals._Emission.xxyz.yzw;
    output.SV_Target0.xyz = half3(fma(float3(u_xlat16_5.xyz), float3(FGlobals._EmissionIntensity), u_xlat4.xyz));
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_5.xyz = unity_Lightmap.sample(samplerunity_Lightmap, input.TEXCOORD6.xy).xyz;
    u_xlat16_6.xyz = fma(FGlobals.unity_Lightmap_HDR.xxx, u_xlat16_5.xyz, u_xlat16_14.xyz);
    u_xlat16_6.xyz = u_xlat16_3.zzz * u_xlat16_6.xyz;
    u_xlat16_3.xyz = fma(u_xlat16_6.xyz, u_xlat16_7.xyz, u_xlat16_3.xyw);
    u_xlat16_0 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD8.xy);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat6.xyw = fma(u_xlat6.xxx, float3(u_xlat16_4.xyz), float3(u_xlat16_7.xyz));
    u_xlat16_0 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD8.xy);
    u_xlat16_3.x = dot(u_xlat16_0, FGlobals.unity_OcclusionMaskSelector);
    u_xlat16_3.x = clamp(u_xlat16_3.x, 0.0h, 1.0h);
    u_xlat16_3.xyw = u_xlat16_3.xxx * FGlobals._LightColor0.xyz;
    u_xlat6.xyw = float3(u_xlat16_3.xyw) * u_xlat6.xyw;
    u_xlat9.x = dot(u_xlat1.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat9.x = clamp(u_xlat9.x, 0.0f, 1.0f);
    u_xlat6.xyw = fma(u_xlat6.xyw, u_xlat9.xxx, float3(u_xlat16_2.xyz));
    u_xlat16_2.x = dot((-u_xlat16.xyz), u_xlat1.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_4.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * FGlobals._Emission.xxyz.yzw;
    u_xlat16_3.xyz = fma(u_xlat16_4.xyz, half3(FGlobals._EmissionIntensity), u_xlat16_3.xyz);
    u_xlat16_4.xyz = u_xlat16_3.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat37 = input.TEXCOORD7;
    u_xlat37 = clamp(u_xlat37, 0.0f, 1.0f);
    u_xlat4.xyz = fma(float3(u_xlat37), float3(u_xlat16_4.xyz), float3(FGlobals.unity_FogColor.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.zw).xyz;
    u_xlat16_6.xyz = u_xlat16_6.xyz * FGlobals._Emission.xxyz.yzw;
    u_xlat16_2.xyz = half3(fma(float3(u_xlat16_6.xyz), float3(FGlobals._EmissionIntensity), u_xlat5.xyz));
    u_xlat16_5.xyz = u_xlat16_2.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat38 = input.TEXCOORD7;
    u_xlat38 = clamp(u_xlat38, 0.0f, 1.0f);
    u_xlat5.xyz = fma(float3(u_xlat38), float3(u_xlat16_5.xyz), float3(FGlobals.unity_FogColor.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_5.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.zw).xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * FGlobals._Emission.xxyz.yzw;
    u_xlat16_1.xyz = half3(fma(float3(u_xlat16_5.xyz), float3(FGlobals._EmissionIntensity), u_xlat4.xyz));
    u_xlat16_4.xyz = u_xlat16_1.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat34 = input.TEXCOORD7;
    u_xlat34 = clamp(u_xlat34, 0.0f, 1.0f);
    u_xlat4.xyz = fma(float3(u_xlat34), float3(u_xlat16_4.xyz), float3(FGlobals.unity_FogColor.xyz));
    output.SV_Target0.xyz = half3(u_xlat4.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = fma(u_xlat16_2.xyz, u_xlat16_3.xyz, u_xlat16_1.xyz);
    u_xlat16_2.xyz = u_xlat16_1.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_3.xy = _MSA.sample(sampler_MSA, input.TEXCOORD1.xy).xy;
    u_xlat16_5.xy = max(u_xlat16_3.xy, FGlobals._MinMSA.xy);
    u_xlat16_2.xyz = fma(u_xlat16_5.xxx, u_xlat16_2.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat3.x = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat3.x = rsqrt(u_xlat3.x);
    u_xlat3.xyz = u_xlat3.xxx * u_xlat4.xyz;
    u_xlat4.xyz = (-input.TEXCOORD6.xyz) + FGlobals._WorldSpaceCameraPos.xyzx.xyz;
    ...
    u_xlat3.x = u_xlat3.x * u_xlat3.x;
    u_xlat3.y = (-float(u_xlat16_5.y)) + 1.0;
    u_xlat16_22 = fma((-u_xlat16_5.x), half(0.779083729), half(0.779083729));
    u_xlat3.x = unity_NHxRoughness.sample(samplerunity_NHxRoughness, u_xlat3.xy).x;
    u_xlat3.x = u_xlat3.x * 16.0;
    u_xlat16_2.xyz = half3(float3(u_xlat16_2.xyz) * u_xlat3.xxx);
    u_xlat16_1.xyz = fma(u_xlat16_1.xyz, half3(u_xlat16_22), u_xlat16_2.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.x = fma(u_xlat16_1.x, u_xlat16_1.x, half(1.5));
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_1.x;
    u_xlat18 = u_xlat18 * float(u_xlat16_7.x);
    ...
    u_xlat3.x = dot(input.TEXCOORD3.xyz, float3(u_xlat16_8.xyz));
    u_xlat3.y = dot(input.TEXCOORD4.xyz, float3(u_xlat16_8.xyz));
    u_xlat3.z = dot(input.TEXCOORD5.xyz, float3(u_xlat16_8.xyz));
    u_xlat7.x = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat7.x = rsqrt(u_xlat7.x);
    ...
    u_xlat16_8.xy = fma(u_xlat16_4.xy, half2(0.5, 0.5), half2(0.5, 0.5));
    u_xlat16_1.xyz = _SphereMap.sample(sampler_SphereMap, float2(u_xlat16_8.xy)).xyz;
    u_xlat16_8.xyz = u_xlat16_1.xyz * FGlobals._SphereMapScale.xyz;
    u_xlat16_1.xyz = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = fma(FGlobals._Color.xyz, u_xlat16_1.xyz, FGlobals._AddColor.xyz);
    u_xlat16_1 = _Decal.sample(sampler_Decal, input.TEXCOORD2.xy);
    u_xlat16_1 = fma(u_xlat16_1, FGlobals._Color, FGlobals._AddColor);
    u_xlat16_5.xyz = (-u_xlat16_4.xyz) + u_xlat16_1.xyz;
    u_xlat16_4.xyz = fma(u_xlat16_1.www, u_xlat16_5.xyz, u_xlat16_4.xyz);
    u_xlat16_3.xyz = _SphereMapMask.sample(sampler_SphereMapMask, input.TEXCOORD1.zw).xyz;
    u_xlat16_8.xyz = fma(u_xlat16_8.xyz, u_xlat16_3.xyz, u_xlat16_4.xyz);
    ...
    u_xlat0.xzw = fma(float3(u_xlat16_8.xyz), float3(u_xlat16_2.xxx), u_xlat0.xzw);
    u_xlat0.xzw = u_xlat0.xzw * float3(FGlobals._LightColor0.xyz);
