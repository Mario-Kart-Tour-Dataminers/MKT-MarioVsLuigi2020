    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_8.xyz = fma(FGlobals._Color.xyz, u_xlat16_12.xyz, FGlobals._AddColor.xyz);
    u_xlat16_12.xyz = _SphereMapMask.sample(sampler_SphereMapMask, input.TEXCOORD1.zw).xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = fma(u_xlat16_3.xyz, u_xlat16_0.xyz, u_xlat16_1.xyz);
    u_xlat16_3.xyz = u_xlat16_1.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_0.xy = _MSA.sample(sampler_MSA, input.TEXCOORD1.xy).xy;
    u_xlat16_4.xy = max(u_xlat16_0.xy, FGlobals._MinMSA.xy);
    u_xlat16_3.xyz = fma(u_xlat16_4.xxx, u_xlat16_3.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat0.x = dot(u_xlat2.xyz, u_xlat2.xyz);
    u_xlat0.x = rsqrt(u_xlat0.x);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = _SphereMapMask.sample(sampler_SphereMapMask, input.TEXCOORD1.zw).xyz;
    u_xlat16_7.xyz = fma(u_xlat16_7.xyz, u_xlat16_1.xyz, u_xlat16_4.xyz);
