    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    float u_xlat33;
    u_xlat16_0.xyz = _MSA.sample(sampler_MSA, input.TEXCOORD1.xy).xyz;
    u_xlat16_1.x = u_xlat16_0.z + half(-1.0);
    u_xlat16_11.xy = max(u_xlat16_0.xy, FGlobals._MinMSA.xy);
    u_xlat16_1.x = fma(FGlobals._Occlusion, u_xlat16_1.x, half(1.0));
    u_xlat16_1.x = max(u_xlat16_1.x, FGlobals._MinMSA.z);
    u_xlat0.x = input.TEXCOORD2.w;
    u_xlat0.y = input.TEXCOORD3.w;
    u_xlat0.z = input.TEXCOORD4.w;
    u_xlat30 = dot(u_xlat0.xyz, FGlobals._NormalRand.xyz);
    ...
    u_xlat2.x = u_xlat30 * u_xlat30;
    u_xlat16_1.x = half(u_xlat30 * u_xlat2.x);
    u_xlat30 = fma(u_xlat30, u_xlat30, 1.5);
    ...
    u_xlat16_8.xyz = u_xlat16_7.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = fma(u_xlat16_11.xxx, u_xlat16_8.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_1.x = fma((-u_xlat16_11.x), half(0.779083729), half(0.779083729));
    ...
    u_xlat0.x = min(u_xlat0.x, 100.0);
    u_xlat0.xzw = float3(u_xlat16_8.xyz) * u_xlat0.xxx;
    u_xlat0.xzw = fma(float3(u_xlat16_7.xyz), float3(u_xlat16_1.xxx), u_xlat0.xzw);
    u_xlat0.xzw = u_xlat0.xzw * float3(FGlobals._LightColor0.xyz);
    u_xlat0.xyz = fma(u_xlat0.xzw, float3(u_xlat10), float3(u_xlat16_11.xyz));
    u_xlat16_2.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD1.zw).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * FGlobals._Emission.xxyz.yzw;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD1.zw).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * FGlobals._Emission.xxyz.yzw;
    u_xlat16_2.xyz = half3(fma(float3(u_xlat16_3.xyz), float3(FGlobals._EmissionIntensity), u_xlat0.xyz));
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-FGlobals.unity_FogColor.xyz);
