    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = _BumpMap.sample(sampler_BumpMap, input.TEXCOORD1.xy).xyz;
    ...
    output.SV_Target0.w = u_xlat16_0.x * FGlobals._AlphaFactor;
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    output.SV_Target0.w = u_xlat16_0 * FGlobals._AlphaFactor;
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.zw).x;
    u_xlat16_1.x = (-u_xlat16_1.x) + half(1.0);
    output.SV_Target0.w = u_xlat16_1.x * FGlobals._AlphaFactor;
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat5.x = min(u_xlat5.x, 100.0);
    u_xlat5.xyw = fma(u_xlat5.xxx, float3(u_xlat16_4.xyz), float3(u_xlat16_7.xyz));
    u_xlat16_6 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD8.xy);
