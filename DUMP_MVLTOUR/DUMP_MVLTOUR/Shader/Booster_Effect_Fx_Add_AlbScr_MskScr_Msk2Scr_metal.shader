    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat3.xy = u_xlat0.xx * float2(half2(FGlobals._Alpha2TextureScrollSpeedU, FGlobals._Alpha2TextureScrollSpeedV));
    u_xlat3.xy = fract(u_xlat3.xy);
    u_xlat3.xy = u_xlat3.xy + input.TEXCOORD5.xy;
    u_xlat16_3 = _Alpha2Texture.sample(sampler_Alpha2Texture, u_xlat3.xy).x;
    u_xlat16_3 = (-u_xlat16_3) + half(1.0);
    u_xlat6.xy = u_xlat0.xx * float2(half2(FGlobals._AlphaTextureScrollSpeedU, FGlobals._AlphaTextureScrollSpeedV));
    u_xlat1.xy = u_xlat0.xx * float2(half2(FGlobals._AlbedoScrollSpeedU, FGlobals._AlbedoScrollSpeedV));
    ...
    u_xlat16_0 = _AlphaTexture.sample(sampler_AlphaTexture, u_xlat0.xz).x;
