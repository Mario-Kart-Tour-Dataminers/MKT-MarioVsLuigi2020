    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = fma(u_xlat16_0.xyz, half3(u_xlat16_28), u_xlat16_6.xyz);
    ...
    u_xlat16_2 = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    u_xlat0.w = (-float(u_xlat16_2)) + 1.0;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.xyw = fma(float3(u_xlat16_1.xyz), float3(u_xlat16_6), u_xlat0.xyw);
    ...
    u_xlat16_1.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    u_xlat0.w = (-float(u_xlat16_1.x)) + 1.0;
    output.SV_Target0 = half4(u_xlat0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = half3(u_xlat16_25) * u_xlat16_4.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_19 = (-u_xlat16_19) + FGlobals._Smoothness;
    ...
    u_xlat3.xyz = fma(float3(u_xlat18), float3(u_xlat16_5.xyz), float3(u_xlat16_2.xyz));
    ...
    u_xlat16_8.xyz = half3(u_xlat16_19) + (-u_xlat16_5.xyz);
    ...
    u_xlat16_3 = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    u_xlat0.w = (-float(u_xlat16_3)) + 1.0;
    output.SV_Target0 = half4(u_xlat0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat24 = clamp(u_xlat24, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat24), float3(u_xlat16_0.xyz), float3(FGlobals.unity_FogColor.xyz));
    u_xlat16_4.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    u_xlat0.w = (-float(u_xlat16_4.x)) + 1.0;
    output.SV_Target0 = half4(u_xlat0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_8.xyz = half3(u_xlat16_28) * u_xlat16_9.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_32 = (-u_xlat16_32) + FGlobals._Smoothness;
    u_xlat16_32 = u_xlat16_32 + half(1.0);
    u_xlat16_32 = clamp(u_xlat16_32, 0.0h, 1.0h);
    u_xlat16_7.xyz = fma(FGlobals._Color.xyz, input.COLOR0.xyz, half3(-0.220916301, -0.220916301, -0.220916301));
    u_xlat16_7.xyz = fma(half3(FGlobals._Metallic), u_xlat16_7.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    ...
    u_xlat16_6.xyz = half3(u_xlat16_32) + (-u_xlat16_7.xyz);
    u_xlat16_6.xyz = fma(half3(u_xlat16_33), u_xlat16_6.xyz, u_xlat16_7.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_22 = dot((-u_xlat0.xyz), input.TEXCOORD1.xyz);
    u_xlat16_22 = u_xlat16_22 + u_xlat16_22;
    u_xlat16_2.xyz = half3(fma(input.TEXCOORD1.xyz, (-float3(u_xlat16_22)), (-u_xlat0.xyz)));
    u_xlat16_2 = _HeuristicReflection.sample(sampler_HeuristicReflection, float3(u_xlat16_2.xyz));
    ...
    u_xlat16_24 = (-u_xlat16_22) + FGlobals._Smoothness;
    u_xlat16_24 = u_xlat16_24 + half(1.0);
    u_xlat16_24 = clamp(u_xlat16_24, 0.0h, 1.0h);
    u_xlat16_5.xyz = fma(FGlobals._Color.xyz, input.COLOR0.xyz, half3(-0.220916301, -0.220916301, -0.220916301));
    u_xlat16_5.xyz = fma(half3(FGlobals._Metallic), u_xlat16_5.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_6.xyz = half3(u_xlat16_24) + (-u_xlat16_5.xyz);
    u_xlat16_6.xyz = fma(half3(u_xlat16_7), u_xlat16_6.xyz, u_xlat16_5.xyz);
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat16_6.xyz;
    u_xlat16_4.xyz = input.COLOR0.xyz * FGlobals._Color.xyz;
    u_xlat16_6.xyz = half3(u_xlat16_22) * u_xlat16_4.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat21 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat21 = rsqrt(u_xlat21);
    u_xlat3.xyz = fma(u_xlat0.xyz, float3(u_xlat21), float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat0.xyz = float3(u_xlat21) * u_xlat0.xyz;
    ...
    u_xlat16_24 = (-FGlobals._Smoothness) + half(1.0);
    u_xlat16_4 = fma(u_xlat16_24, u_xlat16_24, half(1.5));
    u_xlat21 = u_xlat21 * float(u_xlat16_4);
    u_xlat4.x = dot(input.TEXCOORD1.xyz, input.TEXCOORD1.xyz);
    u_xlat4.x = rsqrt(u_xlat4.x);
    u_xlat4.xyz = u_xlat4.xxx * input.TEXCOORD1.xyz;
    u_xlat3.x = dot(u_xlat4.xyz, u_xlat3.xyz);
    ...
    u_xlat16_5.xyz = fma(FGlobals._Color.xyz, input.COLOR0.xyz, half3(-0.220916301, -0.220916301, -0.220916301));
    u_xlat16_5.xyz = fma(half3(FGlobals._Metallic), u_xlat16_5.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat3.xyz = fma(float3(u_xlat21), float3(u_xlat16_5.xyz), float3(u_xlat16_2.xyz));
    u_xlat16_6 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD5.xy);
    u_xlat16_2.x = dot(u_xlat16_6, FGlobals.unity_OcclusionMaskSelector);
    ...
    u_xlat16_9.xyz = half3(u_xlat16_22) + (-u_xlat16_5.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_8 = u_xlat16_25 * u_xlat16_8;
    u_xlat16_25 = fma((-FGlobals._Metallic), half(0.779083729), half(0.779083729));
    u_xlat16_29 = (-u_xlat16_25) + FGlobals._Smoothness;
    u_xlat16_29 = u_xlat16_29 + half(1.0);
    u_xlat16_29 = clamp(u_xlat16_29, 0.0h, 1.0h);
    u_xlat16_6.xyz = fma(FGlobals._Color.xyz, input.COLOR0.xyz, half3(-0.220916301, -0.220916301, -0.220916301));
    u_xlat16_6.xyz = fma(half3(FGlobals._Metallic), u_xlat16_6.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    ...
    u_xlat16_7.xyz = half3(u_xlat16_25) * u_xlat16_3.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.xyz = fma(u_xlat0.xxx, float3(u_xlat16_7.xyz), float3(u_xlat16_6.xyz));
    u_xlat16_2 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD5.xy);
    u_xlat16_33 = dot(u_xlat16_2, FGlobals.unity_OcclusionMaskSelector);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = input.COLOR0.xyz * FGlobals._Color.xyz;
    u_xlat16_11 = fma((-FGlobals._Metallic), half(0.779083729), half(0.779083729));
    u_xlat16_4.xyz = u_xlat16_1.xyz * half3(u_xlat16_11);
    u_xlat16_11 = (-u_xlat16_11) + FGlobals._Smoothness;
    u_xlat16_11 = u_xlat16_11 + half(1.0);
    u_xlat16_11 = clamp(u_xlat16_11, 0.0h, 1.0h);
    u_xlat16_5.xyz = fma(FGlobals._Color.xyz, input.COLOR0.xyz, half3(-0.220916301, -0.220916301, -0.220916301));
    u_xlat16_5.xyz = fma(half3(FGlobals._Metallic), u_xlat16_5.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat1.xyz = fma(float3(u_xlat24), float3(u_xlat16_5.xyz), float3(u_xlat16_4.xyz));
    ...
    u_xlat25 = clamp(u_xlat25, 0.0f, 1.0f);
    u_xlat16_19 = half((-u_xlat25) + 1.0);
    u_xlat16_19 = u_xlat16_19 * u_xlat16_19;
    u_xlat16_19 = u_xlat16_19 * u_xlat16_19;
    u_xlat1.xyz = fma(u_xlat1.xyz, float3(u_xlat24), float3(u_xlat16_4.xyz));
    u_xlat16_27 = dot((-u_xlat0.xyz), input.TEXCOORD1.xyz);
    u_xlat16_27 = u_xlat16_27 + u_xlat16_27;
    u_xlat16_4.xyz = half3(fma(input.TEXCOORD1.xyz, (-float3(u_xlat16_27)), (-u_xlat0.xyz)));
    u_xlat16_0 = _HeuristicReflection.sample(sampler_HeuristicReflection, float3(u_xlat16_4.xyz));
    ...
    u_xlat16_3.xyw = half3(u_xlat16_11) + (-u_xlat16_5.xyz);
    u_xlat16_3.xyz = fma(half3(u_xlat16_19), u_xlat16_3.xyw, u_xlat16_5.xyz);
    u_xlat0.xyz = fma(float3(u_xlat16_4.xyz), float3(u_xlat16_3.xyz), u_xlat1.xyz);
    u_xlat16_1.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    u_xlat0.w = (-float(u_xlat16_1.x)) + 1.0;
    output.SV_Target0 = half4(u_xlat0);
    return output;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = fma(FGlobals._Color.xyz, input.COLOR0.xyz, half3(-0.220916301, -0.220916301, -0.220916301));
    u_xlat16_6.xyz = fma(half3(FGlobals._Metallic), u_xlat16_6.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_7.xyz = half3(u_xlat16_32) + (-u_xlat16_6.xyz);
    u_xlat16_7.xyz = fma(u_xlat16_9.xxx, u_xlat16_7.xyz, u_xlat16_6.xyz);
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat16_7.xyz;
    u_xlat16_9.xyz = unity_Lightmap.sample(samplerunity_Lightmap, input.TEXCOORD3.xy).xyz;
    u_xlat16_7.xyz = u_xlat16_9.xyz * FGlobals.unity_Lightmap_HDR.xxx;
    u_xlat16_7.xyz = u_xlat16_7.xyz * half3(FGlobals._Occlusion);
    u_xlat16_9.xyz = input.COLOR0.xyz * FGlobals._Color.xyz;
    u_xlat16_8.xyz = half3(u_xlat16_31) * u_xlat16_9.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat27 = rsqrt(u_xlat27);
    u_xlat3.xyz = float3(u_xlat27) * u_xlat3.xyz;
    u_xlat16_24 = dot((-u_xlat3.xyz), input.TEXCOORD1.xyz);
    u_xlat16_24 = u_xlat16_24 + u_xlat16_24;
    u_xlat16_2.xyz = half3(fma(input.TEXCOORD1.xyz, (-float3(u_xlat16_24)), (-u_xlat3.xyz)));
    ...
    u_xlat16_4.xyz = input.COLOR0.xyz * FGlobals._Color.xyz;
    u_xlat16_7.xyz = half3(u_xlat16_24) * u_xlat16_4.xyz;
    ...
    u_xlat16_3.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = half3(u_xlat16_21) * u_xlat16_3.xyz;
    ...
    u_xlat16_0.x = dot((-u_xlat3.xyz), input.TEXCOORD1.xyz);
    u_xlat16_0.x = u_xlat16_0.x + u_xlat16_0.x;
    u_xlat16_0.xyz = half3(fma(input.TEXCOORD1.xyz, (-float3(u_xlat16_0.xxx)), (-u_xlat3.xyz)));
    ...
    u_xlat16_9.xyz = half3(u_xlat16_21) + (-u_xlat16_6.xyz);
    u_xlat16_2.xyz = fma(u_xlat16_2.xxx, u_xlat16_9.xyz, u_xlat16_6.xyz);
    u_xlat0.xyz = fma(float3(u_xlat16_0.xyz), float3(u_xlat16_2.xyz), u_xlat4.xyz);
    u_xlat16_3.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_8.xyz = fma(u_xlat16_12.xxx, u_xlat16_8.xyz, u_xlat16_7.xyz);
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_8.xyz;
    u_xlat16_12.xyz = input.COLOR0.xyz * FGlobals._Color.xyz;
    u_xlat16_8.xyz = half3(u_xlat16_27) * u_xlat16_12.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.x = max(u_xlat0.x, 0.0);
    u_xlat0.x = min(u_xlat0.x, 100.0);
    u_xlat16_11.xyz = input.COLOR0.xyz * FGlobals._Color.xyz;
    u_xlat16_38 = fma((-FGlobals._Metallic), half(0.779083729), half(0.779083729));
    u_xlat16_6.xyz = u_xlat16_11.xyz * half3(u_xlat16_38);
    ...
    u_xlat16_8.x = dot(FGlobals.unity_SHBr, u_xlat16_2);
    u_xlat16_8.y = dot(FGlobals.unity_SHBg, u_xlat16_2);
    u_xlat16_8.z = dot(FGlobals.unity_SHBb, u_xlat16_2);
    u_xlat16_8.xyz = fma(FGlobals.unity_SHC.xyz, half3(u_xlat16_39), u_xlat16_8.xyz);
    u_xlat2.xyz = input.TEXCOORD1.xyz;
    u_xlat2.w = 1.0;
    ...
    u_xlat16_8.xyz = fma(FGlobals.unity_Lightmap_HDR.xxx, u_xlat16_10.xyz, u_xlat16_4.xyz);
    u_xlat16_8.xyz = u_xlat16_8.xyz * half3(FGlobals._Occlusion);
    u_xlat16_6.xyz = u_xlat16_6.xyz * u_xlat16_8.xyz;
    ...
    u_xlat1 = clamp(u_xlat1, 0.0f, 1.0f);
    u_xlat16_39 = half((-u_xlat1) + 1.0);
    u_xlat16_39 = u_xlat16_39 * u_xlat16_39;
    u_xlat16_39 = u_xlat16_39 * u_xlat16_39;
    u_xlat0.xyz = fma(u_xlat0.xyz, float3(u_xlat33), float3(u_xlat16_6.xyz));
    u_xlat16_6.xyz = half3(u_xlat16_38) + (-u_xlat16_7.xyz);
    u_xlat16_6.xyz = fma(half3(u_xlat16_39), u_xlat16_6.xyz, u_xlat16_7.xyz);
    u_xlat0.xyz = fma(float3(u_xlat16_5.xyz), float3(u_xlat16_6.xyz), u_xlat0.xyz);
    u_xlat16_1 = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    u_xlat0.w = (-float(u_xlat16_1)) + 1.0;
    output.SV_Target0 = half4(u_xlat0);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_4.x = (-u_xlat16_23) + FGlobals._Smoothness;
    u_xlat16_4.x = u_xlat16_4.x + half(1.0);
    u_xlat16_4.x = clamp(u_xlat16_4.x, 0.0h, 1.0h);
    u_xlat16_11.xyz = fma(FGlobals._Color.xyz, input.COLOR0.xyz, half3(-0.220916301, -0.220916301, -0.220916301));
    ...
    u_xlat16_5.xyz = fma(half3(u_xlat16_7), u_xlat16_5.xyz, u_xlat16_11.xyz);
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_5.xyz;
    u_xlat16_3.xyz = unity_Lightmap.sample(samplerunity_Lightmap, input.TEXCOORD3.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_3.xyz * FGlobals.unity_Lightmap_HDR.xxx;
    u_xlat16_5.xyz = u_xlat16_5.xyz * half3(FGlobals._Occlusion);
    u_xlat16_3.xyz = input.COLOR0.xyz * FGlobals._Color.xyz;
    u_xlat16_6.xyz = half3(u_xlat16_23) * u_xlat16_3.xyz;
    ...
    u_xlat0.x = unity_NHxRoughness.sample(samplerunity_NHxRoughness, u_xlat0.xz).x;
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_4.xyz = half3(fma(u_xlat0.xxx, float3(u_xlat16_11.xyz), float3(u_xlat16_6.xyz)));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_4.x = (-u_xlat16_4.x) + FGlobals._Smoothness;
    u_xlat16_4.x = u_xlat16_4.x + half(1.0);
    u_xlat16_4.x = clamp(u_xlat16_4.x, 0.0h, 1.0h);
    u_xlat16_5.xyz = fma(FGlobals._Color.xyz, input.COLOR0.xyz, half3(-0.220916301, -0.220916301, -0.220916301));
    u_xlat16_5.xyz = fma(half3(FGlobals._Metallic), u_xlat16_5.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat2.xyz = fma(float3(u_xlat21), float3(u_xlat16_5.xyz), float3(u_xlat16_11.xyz));
    ...
    u_xlat16_11.x = half((-u_xlat23) + 1.0);
    ...
    u_xlat16_2.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_13.xyz = fma(FGlobals._Color.xyz, input.COLOR0.xyz, half3(-0.220916301, -0.220916301, -0.220916301));
    ...
    u_xlat16_6.xyz = fma(half3(u_xlat16_8), u_xlat16_6.xyz, u_xlat16_13.xyz);
    ...
    u_xlat16_5.xyz = half3(fma(u_xlat0.xxx, float3(u_xlat16_13.xyz), float3(u_xlat16_7.xyz)));
    u_xlat16_1 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD5.xy);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat24 = rsqrt(u_xlat24);
    u_xlat3.xyz = float3(u_xlat24) * u_xlat3.xyz;
    u_xlat16_21 = dot((-u_xlat3.xyz), input.TEXCOORD1.xyz);
    u_xlat16_21 = u_xlat16_21 + u_xlat16_21;
    u_xlat16_2.xyz = half3(fma(input.TEXCOORD1.xyz, (-float3(u_xlat16_21)), (-u_xlat3.xyz)));
    u_xlat16_1 = _HeuristicReflection.sample(sampler_HeuristicReflection, float3(u_xlat16_2.xyz));
    ...
    u_xlat16_10 = u_xlat16_21 * u_xlat16_10;
    u_xlat16_21 = fma((-FGlobals._Metallic), half(0.779083729), half(0.779083729));
    u_xlat16_23 = (-u_xlat16_21) + FGlobals._Smoothness;
    u_xlat16_23 = u_xlat16_23 + half(1.0);
    u_xlat16_23 = clamp(u_xlat16_23, 0.0h, 1.0h);
    u_xlat16_5.xyz = fma(FGlobals._Color.xyz, input.COLOR0.xyz, half3(-0.220916301, -0.220916301, -0.220916301));
    u_xlat16_5.xyz = fma(half3(FGlobals._Metallic), u_xlat16_5.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_6.xyz = half3(u_xlat16_23) + (-u_xlat16_5.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.xyz = fma(u_xlat0.xxx, float3(u_xlat16_7.xyz), float3(u_xlat16_6.xyz));
    u_xlat16_2 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD5.xy);
    u_xlat16_39 = dot(u_xlat16_2, FGlobals.unity_OcclusionMaskSelector);
    u_xlat16_39 = clamp(u_xlat16_39, 0.0h, 1.0h);
    u_xlat16_8.xyz = half3(u_xlat16_39) * FGlobals._LightColor0.xyz;
    u_xlat0.xyz = u_xlat0.xyz * float3(u_xlat16_8.xyz);
    u_xlat16_39 = half(input.TEXCOORD1.y * input.TEXCOORD1.y);
    u_xlat16_39 = half(fma(input.TEXCOORD1.x, input.TEXCOORD1.x, (-float(u_xlat16_39))));
    u_xlat16_2 = half4(input.TEXCOORD1.yzzx * input.TEXCOORD1.xyzz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0.xyz = input.COLOR0.xyz * FGlobals._Color.xyz;
    u_xlat16_5.xyz = fma(u_xlat16_0.xyz, half3(u_xlat16_23), u_xlat16_5.xyz);
    output.SV_Target0.xyz = fma(u_xlat16_5.xyz, u_xlat16_4.xyz, u_xlat16_2.xyz);
    u_xlat16_0.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    u_xlat16_0.x = (-u_xlat16_0.x) + half(1.0);
    output.SV_Target0.w = u_xlat16_0.x;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat1.xyz = fma(float3(u_xlat16_4.xyz), float3(u_xlat16_5.xxx), u_xlat1.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat27 = input.TEXCOORD4;
    u_xlat27 = clamp(u_xlat27, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat27), float3(u_xlat16_3.xyz), float3(FGlobals.unity_FogColor.xyz));
    u_xlat16_3.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    u_xlat0.w = (-float(u_xlat16_3.x)) + 1.0;
    output.SV_Target0 = half4(u_xlat0);
    return output;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat24 = input.TEXCOORD4;
    u_xlat24 = clamp(u_xlat24, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat24), u_xlat3.xyz, float3(FGlobals.unity_FogColor.xyz));
    u_xlat16_3.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    u_xlat0.w = (-float(u_xlat16_3.x)) + 1.0;
    output.SV_Target0 = half4(u_xlat0);
    return output;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat24 = input.TEXCOORD4;
    u_xlat24 = clamp(u_xlat24, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat24), float3(u_xlat16_3.xyz), float3(FGlobals.unity_FogColor.xyz));
    u_xlat16_3.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.xy).x;
    u_xlat0.w = (-float(u_xlat16_3.x)) + 1.0;
    output.SV_Target0 = half4(u_xlat0);
    return output;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = fma(u_xlat16_0.xyz, half3(u_xlat16_14), u_xlat16_3.xyz);
