    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    output.SV_Target0.xyz = fma(u_xlat16_12.xyz, u_xlat16_11.xyz, u_xlat16_0.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    output.SV_Target0.xyz = fma(u_xlat16_11.xyz, u_xlat16_7.xyz, u_xlat16_0.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
"
