    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat4.xy = u_xlat0.xx * float2(half2(FGlobals._AlbedoScrollSpeedU, FGlobals._AlbedoScrollSpeedV));
    ...
    u_xlat0.xw = u_xlat0.xw + input.TEXCOORD1.xy;
    u_xlat16_0 = _AlphaTexture.sample(sampler_AlphaTexture, u_xlat0.xw).x;
    ...
    u_xlat4.xyz = float3(u_xlat16_4.xyz) * u_xlat1.xyz;
    output.SV_Target0.w = float(u_xlat16_0) * u_xlat1.w;
    u_xlat16_2.xyz = half3(u_xlat4.xyz * float3(0.779083729, 0.779083729, 0.779083729));
    u_xlat16_3.xyz = fma(FGlobals._LightColor0.xyz, half3(FGlobals._reflectance), half3(FGlobals._Occlusion));
    output.SV_Target0.xyz = float3(u_xlat16_2.xyz) * float3(u_xlat16_3.xyz);
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.xw = fract(u_xlat0.xw);
    u_xlat0.xw = u_xlat0.xw + input.TEXCOORD1.xy;
    u_xlat16_0.x = _AlphaTexture.sample(sampler_AlphaTexture, u_xlat0.xw).x;
    ...
    u_xlat16_2.xyz = half3(u_xlat4.xyz * float3(0.779083729, 0.779083729, 0.779083729));
    u_xlat16_3.xyz = fma(FGlobals._LightColor0.xyz, half3(FGlobals._reflectance), half3(FGlobals._Occlusion));
    u_xlat16_0.xyz = fma(u_xlat16_2.xyz, u_xlat16_3.xyz, (-FGlobals.unity_FogColor.xyz));
    u_xlat12 = input.TEXCOORD5;
    u_xlat12 = clamp(u_xlat12, 0.0f, 1.0f);
    output.SV_Target0.xyz = fma(float3(u_xlat12), float3(u_xlat16_0.xyz), float3(FGlobals.unity_FogColor.xyz));
    return output;
}
"
}
