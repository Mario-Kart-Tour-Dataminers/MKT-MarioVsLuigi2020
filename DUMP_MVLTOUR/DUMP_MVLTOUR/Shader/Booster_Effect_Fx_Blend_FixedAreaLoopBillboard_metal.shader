    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    u_xlat1.xy = u_xlat18.xy * input.TEXCOORD0.xy;
    u_xlat18.xy = float2(1.0, 1.0) / u_xlat18.xy;
    u_xlat1.xy = trunc(u_xlat1.xy);
    u_xlat0.xy = fma(u_xlat18.xy, u_xlat1.xy, u_xlat0.xy);
    ...
    u_xlat3.xyz = u_xlat2.xyz + (-VGlobals._WorldSpaceCameraPos.xyzx.xyz);
    ...
    u_xlat3.xy = float2(u_xlat27) + (-float2(VGlobals._CamNearFadeAlphaZeroDist, VGlobals._CamFarFadeAlphaOneDist));
    u_xlat27 = u_xlat28 / VGlobals._CamScaleLimitDist;
    u_xlat27 = u_xlat27 + 0.00100000005;
    u_xlat28 = dot(u_xlat2.xyz, u_xlat2.xyz);
    u_xlat28 = rsqrt(u_xlat28);
    u_xlat2.xyz = float3(u_xlat28) * u_xlat2.xyz;
    u_xlat4.x = dot(VGlobals.hlslcc_mtx4x4unity_ObjectToWorld[0].xyz, u_xlat2.xyz);
    u_xlat4.y = dot(VGlobals.hlslcc_mtx4x4unity_ObjectToWorld[1].xyz, u_xlat2.xyz);
    u_xlat4.z = dot(VGlobals.hlslcc_mtx4x4unity_ObjectToWorld[2].xyz, u_xlat2.xyz);
    u_xlat2.xyz = u_xlat4.zxy * float3(1.0, 0.0, 0.0);
    u_xlat2.xyz = fma(u_xlat4.yzx, float3(0.0, 0.0, 1.0), (-u_xlat2.xyz));
    u_xlat28 = dot(u_xlat2.xz, u_xlat2.xz);
    u_xlat28 = rsqrt(u_xlat28);
    u_xlat2.xyz = float3(u_xlat28) * u_xlat2.xyz;
    u_xlat28 = fma((-VGlobals._PtclScaleRnd), input.TEXCOORD1.x, 1.0);
    u_xlat5.xy = input.POSITION0.xy * float2(VGlobals._PtclScaleX, VGlobals._PtclScaleY);
    u_xlat5.z = input.POSITION0.z;
    u_xlat5.xyz = float3(u_xlat28) * u_xlat5.xyz;
    u_xlat6.xyz = u_xlat5.yyy * float3(0.0, 1.0, 0.0);
    u_xlat2.xyz = fma(u_xlat5.xxx, u_xlat2.xyz, u_xlat6.xyz);
    u_xlat2.xyz = fma(u_xlat5.zzz, u_xlat4.xyz, u_xlat2.xyz);
