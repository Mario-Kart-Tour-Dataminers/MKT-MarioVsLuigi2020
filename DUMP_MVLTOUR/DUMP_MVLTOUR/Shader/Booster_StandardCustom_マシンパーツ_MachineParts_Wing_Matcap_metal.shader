    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_26.xy = fma(u_xlat16_7.xy, half2(0.5, 0.5), half2(0.5, 0.5));
    u_xlat16_1.xyz = _SphereMap.sample(sampler_SphereMap, float2(u_xlat16_26.xy)).xyz;
    u_xlat16_4 = _Decal.sample(sampler_Decal, input.TEXCOORD1.zw);
    u_xlat16_4 = fma(u_xlat16_4, FGlobals._Color, FGlobals._AddColor);
    u_xlat16_7 = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xy);
    u_xlat16_7 = fma(FGlobals._Color, u_xlat16_7, FGlobals._AddColor);
    u_xlat16_8.xyz = u_xlat16_4.xyz + (-u_xlat16_7.xyz);
    u_xlat16_8.xyz = fma(u_xlat16_4.www, u_xlat16_8.xyz, u_xlat16_7.xyz);
    output.SV_Target0.w = u_xlat16_7.w * FGlobals._AlphaFactor;
    u_xlat16_8.xyz = fma(u_xlat16_1.xyz, FGlobals._SphereMapScale.xyz, u_xlat16_8.xyz);
    u_xlat16_9.xyz = u_xlat16_8.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_9.xyz = fma(u_xlat16_2.xxx, u_xlat16_9.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    ...
    u_xlat16_11.xyz = half3(float3(u_xlat16_9.xyz) * u_xlat0.xxx);
    u_xlat16_8.xyz = fma(u_xlat16_8.xyz, u_xlat16_2.xxx, u_xlat16_11.xyz);
    u_xlat16_2.x = half((-u_xlat1.x) + 1.0);
    u_xlat16_0.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat16_0.x = u_xlat16_2.x * u_xlat16_0.x;
    u_xlat16_0.x = u_xlat16_2.x * u_xlat16_0.x;
    u_xlat16_2.xyz = fma(u_xlat16_0.xxx, u_xlat16_14.xyz, u_xlat16_9.xyz);
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_6.xyz;
    u_xlat16_2.xyz = fma(u_xlat16_8.xyz, u_xlat16_10.xyz, u_xlat16_2.xyz);
    ...
    u_xlat16_2.xyz = fma(u_xlat16_6.xyz, u_xlat16_0.xyz, u_xlat16_2.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_0.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    output.SV_Target0.xyz = fma(u_xlat16_6.xyz, u_xlat16_0.xyz, u_xlat16_2.xyz);
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = fma(u_xlat16_2.www, u_xlat16_7.xyz, u_xlat16_5.xyz);
    ...
    u_xlat16_1.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0.x = u_xlat16_39 * u_xlat16_0.x;
    u_xlat16_3.xyw = fma(u_xlat16_0.xxx, u_xlat16_3.xyw, u_xlat16_9.xyz);
    ...
    u_xlat16_3.xyz = fma(u_xlat16_9.xyz, u_xlat16_8.xyz, u_xlat16_3.xyw);
    u_xlat16_3.xyz = fma(u_xlat16_10.xyz, u_xlat16_6.xyz, u_xlat16_3.xyz);
    u_xlat16_6.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_0.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    output.SV_Target0.xyz = fma(u_xlat16_6.xyz, u_xlat16_0.xyz, u_xlat16_3.xyz);
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    bool u_xlatb36;
    float u_xlat37;
    u_xlat16_0 = _Decal.sample(sampler_Decal, input.TEXCOORD1.zw);
    u_xlat16_0 = fma(u_xlat16_0, FGlobals._Color, FGlobals._AddColor);
    u_xlat16_1 = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xy);
    u_xlat16_1 = fma(FGlobals._Color, u_xlat16_1, FGlobals._AddColor);
    u_xlat16_2.xyz = u_xlat16_0.xyz + (-u_xlat16_1.xyz);
    u_xlat16_2.xyz = fma(u_xlat16_0.www, u_xlat16_2.xyz, u_xlat16_1.xyz);
    ...
    u_xlat16_3.xyz = _SphereMap.sample(sampler_SphereMap, float2(u_xlat16_5.xy)).xyz;
    u_xlat16_2.xyz = fma(u_xlat16_3.xyz, FGlobals._SphereMapScale.xyz, u_xlat16_2.xyz);
    u_xlat16_3.xyz = _MSA.sample(sampler_MSA, input.TEXCOORD1.xy).xyz;
    u_xlat16_5.xyz = max(u_xlat16_3.xyz, FGlobals._MinMSA.xyz);
    u_xlat16_35 = fma((-u_xlat16_5.x), half(0.779083729), half(0.779083729));
    u_xlat16_6.xyz = half3(u_xlat16_35) * u_xlat16_2.xyz;
    ...
    u_xlat9.xyz = fma(u_xlat4.xyz, u_xlat14.xxx, float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat4.xyw = fma(u_xlat4.xxx, float3(u_xlat16_2.xyz), float3(u_xlat16_6.xyz));
    u_xlat4.xyw = u_xlat4.xyw * float3(FGlobals._LightColor0.xyz);
    u_xlat9.x = dot(u_xlat0.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat9.x = clamp(u_xlat9.x, 0.0f, 1.0f);
    u_xlat4.xyw = fma(u_xlat4.xyw, u_xlat9.xxx, float3(u_xlat16_8.xyz));
    u_xlat16_5.x = dot((-u_xlat14.xyz), u_xlat0.xyz);
    u_xlat16_5.x = u_xlat16_5.x + u_xlat16_5.x;
    u_xlat16_5.xyw = half3(fma(u_xlat0.xyz, (-float3(u_xlat16_5.xxx)), (-u_xlat14.xyz)));
    u_xlat14.x = dot(u_xlat0.xyz, u_xlat14.xyz);
    u_xlat14.x = clamp(u_xlat14.x, 0.0f, 1.0f);
    u_xlat16_6.x = half((-u_xlat14.x) + 1.0);
    u_xlat16_6.x = u_xlat16_6.x * u_xlat16_6.x;
    u_xlat16_6.x = u_xlat16_6.x * u_xlat16_6.x;
    u_xlat16_2.xyz = fma(u_xlat16_6.xxx, u_xlat16_7.xyz, u_xlat16_2.xyz);
    u_xlat14.x = dot(u_xlat16_5.wxy, (-u_xlat16_5.xyw));
    u_xlatb14 = u_xlat14.x<9.99999975e-06;
    u_xlat14.x = (u_xlatb14) ? float(u_xlat16_5.w) : (-float(u_xlat16_5.w));
    u_xlat9.z = u_xlat14.x * float(u_xlat16_5.x);
    u_xlat10.x = u_xlat14.x * float(u_xlat16_5.w);
    u_xlat9.xy = (-float2(u_xlat16_5.xy)) * float2(u_xlat16_5.yw);
    ...
    u_xlat14.xyz = u_xlat14.xyz * float3(FGlobals._NormalDiff);
    u_xlat3.xyz = fma(u_xlat14.xyz, u_xlat3.xxx, float3(u_xlat16_5.xyw));
    u_xlat36 = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat36 = rsqrt(u_xlat36);
    u_xlat3.xyz = float3(u_xlat36) * u_xlat3.xyz;
    u_xlatb36 = u_xlat26<0.00499999989;
    u_xlat26 = u_xlat26 * 8.29800034;
    u_xlat16_5.x = (u_xlatb36) ? half(0.0) : half(u_xlat26);
    u_xlat16_0 = unity_SpecCube0.sample(samplerunity_SpecCube0, u_xlat3.xyz, bias(float(u_xlat16_5.x)));
    ...
    u_xlat3.xyz = fma(float3(u_xlat16_5.xyz), float3(u_xlat16_2.xyz), u_xlat4.xyw);
    ...
    output.SV_Target0.xyz = half3(fma(float3(u_xlat16_2.xyz), float3(u_xlat16_4.xyz), u_xlat3.xyz));
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_0.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    u_xlat16_3.xyz = fma(u_xlat16_6.xyz, u_xlat16_0.xyz, u_xlat16_3.xyz);
    u_xlat16_0.xyz = u_xlat16_3.xyz + (-FGlobals.unity_FogColor.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = fma(u_xlat16_6.xyz, u_xlat16_8.xyz, u_xlat16_3.xyw);
    u_xlat16_1 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD8.xy);
    u_xlat16_36 = dot(u_xlat16_1, FGlobals.unity_OcclusionMaskSelector);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_5.xyw = u_xlat16_5.xxx * FGlobals._LightColor0.xyz;
    u_xlat4.xyw = u_xlat4.xyw * float3(u_xlat16_5.xyw);
    u_xlat9.x = dot(u_xlat0.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat9.x = clamp(u_xlat9.x, 0.0f, 1.0f);
    u_xlat4.xyw = fma(u_xlat4.xyw, u_xlat9.xxx, float3(u_xlat16_8.xyz));
    u_xlat16_5.x = dot((-u_xlat14.xyz), u_xlat0.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_4.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    u_xlat16_2.xyz = half3(fma(float3(u_xlat16_2.xyz), float3(u_xlat16_4.xyz), u_xlat3.xyz));
    u_xlat16_3.xyz = u_xlat16_2.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat36 = input.TEXCOORD7;
    u_xlat36 = clamp(u_xlat36, 0.0f, 1.0f);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0.x = u_xlat16_42 * u_xlat16_0.x;
    u_xlat16_2.xyw = fma(u_xlat16_0.xxx, u_xlat16_2.xyw, u_xlat16_9.xyz);
    ...
    u_xlat16_6.xyz = u_xlat16_2.zzz * u_xlat16_6.xyz;
    u_xlat16_2.xyz = fma(u_xlat16_6.xyz, u_xlat16_8.xyz, u_xlat16_2.xyw);
    u_xlat16_2.xyz = fma(u_xlat16_11.xyz, u_xlat16_10.xyz, u_xlat16_2.xyz);
    u_xlat16_6.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_0.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    output.SV_Target0.xyz = fma(u_xlat16_6.xyz, u_xlat16_0.xyz, u_xlat16_2.xyz);
    return output;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = _MSA.sample(sampler_MSA, input.TEXCOORD1.xy).xyz;
    u_xlat16_6.xyz = max(u_xlat16_3.xyz, FGlobals._MinMSA.xyz);
    u_xlat16_5.xyz = fma(u_xlat16_6.xxx, u_xlat16_5.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_32 = fma((-u_xlat16_6.x), half(0.779083729), half(0.779083729));
    ...
    u_xlat8.xyz = (-u_xlat4.xyz) + FGlobals._WorldSpaceCameraPos.xyzx.xyz;
    u_xlat33 = dot(u_xlat4.xyz, FGlobals._NormalRand.xyz);
    u_xlat33 = sin(u_xlat33);
    u_xlat33 = u_xlat33 * FGlobals._NormalRand.w;
    u_xlat33 = fract(u_xlat33);
    u_xlat4.x = dot(u_xlat8.xyz, u_xlat8.xyz);
    u_xlat4.x = rsqrt(u_xlat4.x);
    u_xlat14.xyz = fma(u_xlat8.xyz, u_xlat4.xxx, float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat38 = fma(u_xlat34, u_xlat34, -1.0);
    u_xlat14.x = fma(u_xlat14.x, u_xlat38, 1.00001001);
    u_xlat38 = fma(u_xlat24, u_xlat24, 1.5);
    u_xlat4.x = u_xlat4.x * u_xlat38;
    u_xlat4.x = u_xlat14.x * u_xlat4.x;
    u_xlat4.x = u_xlat34 / u_xlat4.x;
    u_xlat16_32 = half(u_xlat24 * u_xlat34);
    u_xlat16_32 = fma((-u_xlat16_32), half(0.280000001), half(1.0));
    u_xlat4.x = u_xlat4.x + -9.99999975e-05;
    u_xlat4.x = max(u_xlat4.x, 0.0);
    u_xlat4.x = min(u_xlat4.x, 100.0);
    u_xlat4.xyw = fma(u_xlat4.xxx, float3(u_xlat16_5.xyz), float3(u_xlat16_2.xyz));
    u_xlat4.xyw = u_xlat4.xyw * float3(FGlobals._LightColor0.xyz);
    u_xlat16_9.xyz = unity_Lightmap.sample(samplerunity_Lightmap, input.TEXCOORD6.xy).xyz;
    u_xlat16_6.xyw = u_xlat16_9.xyz * FGlobals.unity_Lightmap_HDR.xxx;
    u_xlat16_6.xyw = u_xlat16_6.zzz * u_xlat16_6.xyw;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_6.xyw;
    u_xlat38 = dot(u_xlat3.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat38 = clamp(u_xlat38, 0.0f, 1.0f);
    u_xlat4.xyw = fma(u_xlat4.xyw, float3(u_xlat38), float3(u_xlat16_2.xyz));
    u_xlat16_2.x = dot((-u_xlat8.xyz), u_xlat3.xyz);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat16_2.xyz = half3(fma(u_xlat3.xyz, (-float3(u_xlat16_2.xxx)), (-u_xlat8.xyz)));
    u_xlat3.x = dot(u_xlat3.xyz, u_xlat8.xyz);
    u_xlat3.x = clamp(u_xlat3.x, 0.0f, 1.0f);
    u_xlat16_35 = half((-u_xlat3.x) + 1.0);
    u_xlat16_35 = u_xlat16_35 * u_xlat16_35;
    u_xlat16_35 = u_xlat16_35 * u_xlat16_35;
    u_xlat16_5.xyz = fma(half3(u_xlat16_35), u_xlat16_7.xyz, u_xlat16_5.xyz);
    ...
    u_xlat8.z = float(u_xlat16_2.x) * u_xlat3.x;
    u_xlat3.x = float(u_xlat16_2.z) * u_xlat3.x;
    u_xlat8.xy = (-float2(u_xlat16_2.xy)) * float2(u_xlat16_2.yz);
    ...
    u_xlat3.xyz = fma(float3(u_xlat16_2.xyz), float3(u_xlat16_5.xyz), u_xlat4.xyw);
    u_xlat16_2.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_4.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    output.SV_Target0.xyz = half3(fma(float3(u_xlat16_2.xyz), float3(u_xlat16_4.xyz), u_xlat3.xyz));
    return output;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = fma(FGlobals.unity_SHC.xyz, u_xlat16_6.xxx, u_xlat16_9.xyz);
    ...
    u_xlat16_6.xyz = u_xlat16_3.zzz * u_xlat16_6.xyz;
    u_xlat16_3.xyz = fma(u_xlat16_6.xyz, u_xlat16_8.xyz, u_xlat16_3.xyw);
    u_xlat16_3.xyz = fma(u_xlat16_10.xyz, u_xlat16_9.xyz, u_xlat16_3.xyz);
    u_xlat16_6.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_1.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    output.SV_Target0.xyz = fma(u_xlat16_6.xyz, u_xlat16_1.xyz, u_xlat16_3.xyz);
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = fma(u_xlat16_4.www, u_xlat16_7.xyz, u_xlat16_5.xyz);
    output.SV_Target0.w = u_xlat16_5.w * FGlobals._AlphaFactor;
    u_xlat16_7.xyz = fma(u_xlat16_0.xyz, FGlobals._SphereMapScale.xyz, u_xlat16_7.xyz);
    u_xlat16_38 = fma((-u_xlat16_3.x), half(0.779083729), half(0.779083729));
    u_xlat16_8.xyz = half3(u_xlat16_38) * u_xlat16_7.xyz;
    ...
    u_xlat0.y = input.TEXCOORD4.w;
    u_xlat0.z = input.TEXCOORD5.w;
    u_xlat6.xyz = (-u_xlat0.xyz) + FGlobals._WorldSpaceCameraPos.xyzx.xyz;
    ...
    u_xlat10.xyz = fma(u_xlat6.xyz, u_xlat12.xxx, float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat10.x = fma(u_xlat42, u_xlat42, -1.0);
    u_xlat18 = fma(u_xlat18, u_xlat10.x, 1.00001001);
    u_xlat10.x = fma(u_xlat30, u_xlat30, 1.5);
    u_xlat6.x = u_xlat6.x * u_xlat10.x;
    u_xlat6.x = u_xlat18 * u_xlat6.x;
    u_xlat6.x = u_xlat42 / u_xlat6.x;
    u_xlat16_38 = half(u_xlat30 * u_xlat42);
    ...
    u_xlat6.xyw = fma(u_xlat6.xxx, float3(u_xlat16_7.xyz), float3(u_xlat16_8.xyz));
    u_xlat6.xyw = u_xlat6.xyw * float3(FGlobals._LightColor0.xyz);
    u_xlat10.x = dot(u_xlat1.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat10.x = clamp(u_xlat10.x, 0.0f, 1.0f);
    u_xlat6.xyw = fma(u_xlat6.xyw, u_xlat10.xxx, float3(u_xlat16_2.xyz));
    u_xlat16_2.x = dot((-u_xlat12.xyz), u_xlat1.xyz);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat16_2.xyz = half3(fma(u_xlat1.xyz, (-float3(u_xlat16_2.xxx)), (-u_xlat12.xyz)));
    u_xlat12.x = dot(u_xlat1.xyz, u_xlat12.xyz);
    u_xlat12.x = clamp(u_xlat12.x, 0.0f, 1.0f);
    u_xlat16_3.x = half((-u_xlat12.x) + 1.0);
    u_xlat16_3.x = u_xlat16_3.x * u_xlat16_3.x;
    u_xlat16_3.x = u_xlat16_3.x * u_xlat16_3.x;
    ...
    u_xlat12.x = (u_xlatb12) ? float(u_xlat16_2.z) : (-float(u_xlat16_2.z));
    u_xlat10.z = u_xlat12.x * float(u_xlat16_2.x);
    u_xlat11.x = u_xlat12.x * float(u_xlat16_2.z);
    u_xlat10.xy = (-float2(u_xlat16_2.xy)) * float2(u_xlat16_2.yz);
    u_xlat11.yz = (-float2(u_xlat16_2.xy)) * float2(u_xlat16_2.xy);
    ...
    u_xlat0.xyz = fma(u_xlat12.xyz, u_xlat0.xxx, float3(u_xlat16_2.xyz));
    u_xlat36 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat36 = rsqrt(u_xlat36);
    u_xlat0.xyz = float3(u_xlat36) * u_xlat0.xyz;
    u_xlatb36 = u_xlat30<0.00499999989;
    u_xlat30 = u_xlat30 * 8.29800034;
    u_xlat16_2.x = (u_xlatb36) ? half(0.0) : half(u_xlat30);
    ...
    u_xlat16_2.xyz = u_xlat16_2.xyz * half3(u_xlat16_38);
    u_xlat0.xyz = fma(float3(u_xlat16_2.xyz), float3(u_xlat16_3.xyw), u_xlat6.xyw);
    u_xlat16_2.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_6.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    output.SV_Target0.xyz = half3(fma(float3(u_xlat16_2.xyz), float3(u_xlat16_6.xyz), u_xlat0.xyz));
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = fma(u_xlat16_10.xyz, u_xlat16_6.xyz, u_xlat16_2.xyz);
    u_xlat16_6.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_0.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    output.SV_Target0.xyz = fma(u_xlat16_6.xyz, u_xlat16_0.xyz, u_xlat16_2.xyz);
    return output;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = fma(u_xlat16_0.www, u_xlat16_3.xyz, u_xlat16_2.xyz);
    ...
    u_xlat16_3.xyz = fma(u_xlat16_4.xyz, FGlobals._SphereMapScale.xyz, u_xlat16_3.xyz);
    ...
    u_xlat16_7.xyz = max(u_xlat16_4.xyz, FGlobals._MinMSA.xyz);
    u_xlat16_6.xyz = fma(u_xlat16_7.xxx, u_xlat16_6.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_34 = fma((-u_xlat16_7.x), half(0.779083729), half(0.779083729));
    ...
    u_xlat37 = dot(u_xlat5.xyz, FGlobals._NormalRand.xyz);
    ...
    u_xlat16.xyz = fma(u_xlat9.xyz, u_xlat5.xxx, float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat27 = (-float(u_xlat16_7.y)) + 1.0;
    u_xlat38 = u_xlat27 * u_xlat27;
    u_xlat42 = fma(u_xlat38, u_xlat38, -1.0);
    u_xlat16.x = fma(u_xlat16.x, u_xlat42, 1.00001001);
    u_xlat42 = fma(u_xlat27, u_xlat27, 1.5);
    ...
    u_xlat5.xyw = fma(u_xlat5.xxx, float3(u_xlat16_6.xyz), float3(u_xlat16_3.xyz));
    ...
    u_xlat16_1.xyz = u_xlat16_10.xyz * FGlobals.unity_Lightmap_HDR.xxx;
    u_xlat16_1.xyz = u_xlat16_7.zzz * u_xlat16_1.xyz;
    u_xlat16_1.xyz = u_xlat16_3.xyz * u_xlat16_1.xyz;
    u_xlat42 = dot(u_xlat4.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat42 = clamp(u_xlat42, 0.0f, 1.0f);
    u_xlat5.xyw = fma(u_xlat5.xyw, float3(u_xlat42), float3(u_xlat16_1.xyz));
    u_xlat16_1.x = dot((-u_xlat9.xyz), u_xlat4.xyz);
    u_xlat16_1.x = u_xlat16_1.x + u_xlat16_1.x;
    u_xlat16_1.xyz = half3(fma(u_xlat4.xyz, (-float3(u_xlat16_1.xxx)), (-u_xlat9.xyz)));
    u_xlat4.x = dot(u_xlat4.xyz, u_xlat9.xyz);
    u_xlat4.x = clamp(u_xlat4.x, 0.0f, 1.0f);
    u_xlat16_3.x = half((-u_xlat4.x) + 1.0);
    u_xlat16_3.x = u_xlat16_3.x * u_xlat16_3.x;
    u_xlat16_3.x = u_xlat16_3.x * u_xlat16_3.x;
    u_xlat16_3.xyz = fma(u_xlat16_3.xxx, u_xlat16_8.xyz, u_xlat16_6.xyz);
    ...
    u_xlat9.z = float(u_xlat16_1.x) * u_xlat4.x;
    ...
    u_xlat4.xyz = u_xlat4.xyz * float3(FGlobals._NormalDiff);
    u_xlat4.xyz = fma(u_xlat4.xyz, float3(u_xlat37), float3(u_xlat16_1.xyz));
    u_xlat37 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat37 = rsqrt(u_xlat37);
    u_xlat4.xyz = float3(u_xlat37) * u_xlat4.xyz;
    u_xlatb37 = u_xlat27<0.00499999989;
    u_xlat27 = u_xlat27 * 8.29800034;
    u_xlat16_1.x = (u_xlatb37) ? half(0.0) : half(u_xlat27);
    ...
    u_xlat4.xyz = fma(float3(u_xlat16_1.xyz), float3(u_xlat16_3.xyz), u_xlat5.xyw);
    u_xlat16_1.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_5.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    output.SV_Target0.xyz = half3(fma(float3(u_xlat16_1.xyz), float3(u_xlat16_5.xyz), u_xlat4.xyz));
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_5.xyz = unity_Lightmap.sample(samplerunity_Lightmap, input.TEXCOORD6.xy).xyz;
    u_xlat16_6.xyz = fma(FGlobals.unity_Lightmap_HDR.xxx, u_xlat16_5.xyz, u_xlat16_12.xyz);
    u_xlat16_6.xyz = u_xlat16_3.zzz * u_xlat16_6.xyz;
    u_xlat16_3.xyz = fma(u_xlat16_6.xyz, u_xlat16_8.xyz, u_xlat16_3.xyw);
    u_xlat16_0 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD8.xy);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat6.x = min(u_xlat6.x, 100.0);
    u_xlat6.xyw = fma(u_xlat6.xxx, float3(u_xlat16_7.xyz), float3(u_xlat16_8.xyz));
    u_xlat16_4 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD8.xy);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_1.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    u_xlat16_3.xyz = fma(u_xlat16_6.xyz, u_xlat16_1.xyz, u_xlat16_3.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_6.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    u_xlat16_2.xyz = half3(fma(float3(u_xlat16_2.xyz), float3(u_xlat16_6.xyz), u_xlat0.xyz));
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat36 = input.TEXCOORD7;
    u_xlat36 = clamp(u_xlat36, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat36), float3(u_xlat16_0.xyz), float3(FGlobals.unity_FogColor.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_5.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    u_xlat16_1.xyz = half3(fma(float3(u_xlat16_1.xyz), float3(u_xlat16_5.xyz), u_xlat4.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = fma(u_xlat16_3.xyz, FGlobals._SphereMapScale.xyz, u_xlat16_1.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = fma(u_xlat16_3.www, u_xlat16_4.xyz, u_xlat16_7.xyz);
