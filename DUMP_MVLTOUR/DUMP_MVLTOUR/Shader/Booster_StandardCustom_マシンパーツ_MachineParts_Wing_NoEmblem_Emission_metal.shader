    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyw = fma(half3(u_xlat16_8), u_xlat16_1.xyw, u_xlat16_7.xyz);
    u_xlat16_7.xyz = half3(u_xlat0.xxx * float3(u_xlat16_7.xyz));
    u_xlat16_7.xyz = fma(u_xlat16_2.xyz, half3(u_xlat16_17), u_xlat16_7.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_4.xyz = _MSA.sample(sampler_MSA, input.TEXCOORD1.xy).xyz;
    u_xlat16_1.xyz = max(u_xlat16_4.xyz, FGlobals._MinMSA.xyz);
    u_xlat24 = (-float(u_xlat16_1.y)) + 1.0;
    u_xlatb26 = u_xlat24<0.00499999989;
    u_xlat27 = u_xlat24 * 8.29800034;
    u_xlat16_5.x = (u_xlatb26) ? half(0.0) : half(u_xlat27);
    ...
    u_xlat16_6.xyz = fma(u_xlat16_1.xxx, u_xlat16_6.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_7.xyz = half3(u_xlat16_9) + (-u_xlat16_6.xyz);
    u_xlat16_1.xyw = fma(half3(u_xlat16_25), u_xlat16_7.xyz, u_xlat16_6.xyz);
    ...
    u_xlat8.xyz = fma(float3(u_xlat16_4.xyz), float3(u_xlat16_17), u_xlat8.xyz);
    output.SV_Target0.w = u_xlat16_4.w * FGlobals._AlphaFactor;
    u_xlat8.xyz = u_xlat8.xyz * float3(FGlobals._LightColor0.xyz);
    u_xlat0.xyz = fma(u_xlat8.xyz, u_xlat0.xxx, float3(u_xlat16_1.xyw));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_8.xyz = half3(u_xlat16_28) * u_xlat16_3.xyz;
    output.SV_Target0.w = u_xlat16_3.w * FGlobals._AlphaFactor;
    u_xlat16_1.xyz = fma(u_xlat16_1.xyz, u_xlat16_8.xyz, u_xlat16_5.xyz);
    u_xlat16_5.xyz = half3(fma(u_xlat2.xxx, float3(u_xlat16_6.xyz), float3(u_xlat16_8.xyz)));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyw = fma(half3(u_xlat16_28), u_xlat16_8.xyz, u_xlat16_6.xyz);
    u_xlat2.xyz = fma(u_xlat2.xxx, float3(u_xlat16_6.xyz), float3(u_xlat16_7.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = fma(u_xlat16_1.xxx, u_xlat16_6.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_7.xyz = half3(u_xlat16_9) + (-u_xlat16_6.xyz);
    u_xlat16_7.xyz = fma(half3(u_xlat16_10), u_xlat16_7.xyz, u_xlat16_6.xyz);
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_7.xyz;
    u_xlat10.x = dot(u_xlat0.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat10.x = clamp(u_xlat10.x, 0.0f, 1.0f);
    u_xlat0.w = 1.0;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_8.xyz = (-u_xlat16_6.xyz) + u_xlat16_1.xxx;
    u_xlat16_1.xyw = fma(half3(u_xlat16_28), u_xlat16_8.xyz, u_xlat16_6.xyz);
    u_xlat9.xyz = fma(u_xlat9.xxx, float3(u_xlat16_6.xyz), float3(u_xlat16_7.xyz));
    ...
    output.SV_Target0.xyz = half3(fma(float3(u_xlat16_3.xyz), float3(FGlobals._EmissionIntensity), u_xlat0.xyz));
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.x = dot(FGlobals.unity_SHBr, u_xlat16_4);
    u_xlat16_7.y = dot(FGlobals.unity_SHBg, u_xlat16_4);
    u_xlat16_7.z = dot(FGlobals.unity_SHBb, u_xlat16_4);
    u_xlat16_7.xyz = fma(FGlobals.unity_SHC.xyz, u_xlat16_2.xxx, u_xlat16_7.xyz);
    u_xlat10.x = dot(u_xlat1.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat10.x = clamp(u_xlat10.x, 0.0f, 1.0f);
    u_xlat16_8.xyz = half3(u_xlat10.xxx * float3(FGlobals._LightColor0.xyz));
    u_xlat1.w = 1.0;
    ...
    u_xlat16_7.xyz = half3(fma(float3(FGlobals.unity_Lightmap_HDR.xxx), float3(u_xlat16_1.xyz), u_xlat10.xyz));
    u_xlat16_2.xyz = u_xlat16_2.zzz * u_xlat16_7.xyz;
    u_xlat16_7.xyz = half3(u_xlat16_32) * u_xlat16_3.xyz;
    output.SV_Target0.w = u_xlat16_3.w * FGlobals._AlphaFactor;
    u_xlat16_2.xyz = fma(u_xlat16_2.xyz, u_xlat16_7.xyz, u_xlat16_5.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_10.x = half(u_xlat20 * u_xlat28);
    ...
    u_xlat4.xyw = fma(u_xlat4.xxx, float3(u_xlat16_7.xyz), float3(u_xlat16_6.xyz));
    ...
    u_xlat16_10.xyz = half3(u_xlat16_25) + (-u_xlat16_7.xyz);
    u_xlat16_2.xyz = fma(u_xlat16_2.xxx, u_xlat16_10.xyz, u_xlat16_7.xyz);
    u_xlat0.xyz = fma(float3(u_xlat16_1.xyz), float3(u_xlat16_2.xyz), u_xlat4.xyw);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    output.SV_Target0.w = u_xlat16_2.w * FGlobals._AlphaFactor;
    u_xlat16_1.xyz = fma(u_xlat16_1.xyz, u_xlat16_7.xyz, u_xlat16_5.xyz);
    u_xlat16_5.xyz = half3(fma(float3(u_xlat8), float3(u_xlat16_6.xyz), float3(u_xlat16_7.xyz)));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = max(u_xlat16_1.xyz, half3(0.0, 0.0, 0.0));
    u_xlat16_9.xyz = unity_Lightmap.sample(samplerunity_Lightmap, input.TEXCOORD5.xy).xyz;
    u_xlat16_7.xyz = fma(FGlobals.unity_Lightmap_HDR.xxx, u_xlat16_9.xyz, u_xlat16_1.xyz);
    u_xlat16_2.xyz = u_xlat16_2.zzz * u_xlat16_7.xyz;
    u_xlat16_7.xyz = half3(u_xlat16_32) * u_xlat16_3.xyz;
    output.SV_Target0.w = u_xlat16_3.w * FGlobals._AlphaFactor;
    u_xlat16_2.xyz = fma(u_xlat16_2.xyz, u_xlat16_7.xyz, u_xlat16_5.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_11.x = half(u_xlat22 * u_xlat31);
    u_xlat16_11.x = fma((-u_xlat16_11.x), half(0.280000001), half(1.0));
    u_xlat4.x = u_xlat4.x + -9.99999975e-05;
    u_xlat4.x = max(u_xlat4.x, 0.0);
    u_xlat4.x = min(u_xlat4.x, 100.0);
    u_xlat16_8.xyz = u_xlat16_3.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    output.SV_Target0.w = u_xlat16_3.w * FGlobals._AlphaFactor;
    u_xlat16_8.xyz = fma(u_xlat16_2.xxx, u_xlat16_8.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat4.xyw = fma(u_xlat4.xxx, float3(u_xlat16_8.xyz), float3(u_xlat16_6.xyz));
    u_xlat4.xyw = float3(u_xlat16_7.xyz) * u_xlat4.xyw;
    ...
    u_xlat16_11.xyz = half3(u_xlat16_28) + (-u_xlat16_8.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD1.zw).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * FGlobals._Emission.xxyz.yzw;
    u_xlat16_1.xyz = half3(fma(float3(u_xlat16_3.xyz), float3(FGlobals._EmissionIntensity), u_xlat0.xyz));
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat27 = input.TEXCOORD6;
    u_xlat27 = clamp(u_xlat27, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat27), float3(u_xlat16_0.xyz), float3(FGlobals.unity_FogColor.xyz));
