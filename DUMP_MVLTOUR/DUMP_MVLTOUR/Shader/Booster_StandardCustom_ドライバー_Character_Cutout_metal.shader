    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat3.x = dot(input.TEXCOORD2.xyz, float3(u_xlat16_1.xyz));
    u_xlat3.y = dot(input.TEXCOORD3.xyz, float3(u_xlat16_1.xyz));
    u_xlat3.z = dot(input.TEXCOORD4.xyz, float3(u_xlat16_1.xyz));
