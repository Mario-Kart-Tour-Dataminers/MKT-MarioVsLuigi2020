    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_23.x = u_xlat16_5.z + half(-1.0);
    u_xlat16_23.x = fma(FGlobals._Occlusion, u_xlat16_23.x, half(1.0));
    u_xlat16_23.x = max(u_xlat16_23.x, FGlobals._MinMSA.z);
    ...
    u_xlat16_23.xy = fma(u_xlat16_7.xy, half2(0.5, 0.5), half2(0.5, 0.5));
    u_xlat16_2.xyz = _SphereMap.sample(sampler_SphereMap, float2(u_xlat16_23.xy)).xyz;
    ...
    u_xlat16_7.xyz = fma(u_xlat16_7.xyz, u_xlat16_1.xxx, u_xlat16_10.xyz);
    u_xlat16_1.x = half((-u_xlat2.x) + 1.0);
    u_xlat16_0.x = u_xlat16_1.x * u_xlat16_1.x;
    u_xlat16_0.x = u_xlat16_1.x * u_xlat16_0.x;
    u_xlat16_0.x = u_xlat16_1.x * u_xlat16_0.x;
    u_xlat16_1.xyz = fma(u_xlat16_0.xxx, u_xlat16_12.xyz, u_xlat16_8.xyz);
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_6.xyz;
    u_xlat16_1.xyz = fma(u_xlat16_7.xyz, u_xlat16_9.xyz, u_xlat16_1.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0 = u_xlat16_1.x * u_xlat16_0;
    u_xlat16_1.xyz = fma(half3(u_xlat16_0), u_xlat16_12.xyz, u_xlat16_8.xyz);
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_6.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.zw).x;
    u_xlat16_0.x = (-u_xlat16_0.x) + half(1.0);
    u_xlat16_1 = u_xlat16_0.x + (-FGlobals._Cutout);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat32 = dot(u_xlat2.xyz, u_xlat2.xyz);
    u_xlat32 = rsqrt(u_xlat32);
    u_xlat1.xyz = float3(u_xlat32) * u_xlat2.xyz;
    ...
    u_xlat32 = (u_xlatb32) ? float(u_xlat16_3.z) : (-float(u_xlat16_3.z));
    u_xlat4.z = u_xlat32 * float(u_xlat16_3.x);
    u_xlat5.x = u_xlat32 * float(u_xlat16_3.z);
    ...
    u_xlat16_33 = (u_xlatb30) ? half(0.0) : half(u_xlat32);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0.x = u_xlat16_39 * u_xlat16_0.x;
    u_xlat16_1.xyw = fma(u_xlat16_0.xxx, u_xlat16_1.xyw, u_xlat16_8.xyz);
    ...
    u_xlat16_6.xyz = half3(u_xlat16_23) * u_xlat16_6.xyz;
    u_xlat16_1.xyz = fma(u_xlat16_6.xyz, u_xlat16_7.xyz, u_xlat16_1.xyw);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat2.x = clamp(u_xlat2.x, 0.0f, 1.0f);
    u_xlat16_8.xyz = half3(u_xlat2.xxx * float3(FGlobals._LightColor0.xyz));
    u_xlat1.w = 1.0;
    ...
    u_xlat16_6.xyz = fma(FGlobals.unity_Lightmap_HDR.xxx, u_xlat16_4.xyz, u_xlat16_2.xyz);
    u_xlat16_6.xyz = half3(u_xlat16_25) * u_xlat16_6.xyz;
    u_xlat16_3.xyz = fma(u_xlat16_6.xyz, u_xlat16_7.xyz, u_xlat16_3.xyw);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat4.z = float(u_xlat16_1.x) * u_xlat32;
    u_xlat5.x = float(u_xlat16_1.z) * u_xlat32;
    u_xlat4.xy = (-float2(u_xlat16_1.xy)) * float2(u_xlat16_1.yz);
    u_xlat5.yz = (-float2(u_xlat16_1.xy)) * float2(u_xlat16_1.xy);
    u_xlat4.xyz = u_xlat4.xyz + (-u_xlat5.xyz);
    u_xlat32 = dot(u_xlat4.xyz, u_xlat4.xyz);
    ...
    u_xlat4.xyz = float3(u_xlat32) * u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz * float3(FGlobals._NormalDiff);
    u_xlat4.xyz = fma(u_xlat4.xyz, float3(u_xlat30), float3(u_xlat16_1.xyz));
    u_xlat30 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat30 = rsqrt(u_xlat30);
    u_xlat4.xyz = float3(u_xlat30) * u_xlat4.xyz;
    u_xlat16_5.xyz = _MSA.sample(sampler_MSA, input.TEXCOORD1.zw).xyz;
    ...
    u_xlat16_4 = unity_SpecCube0.sample(samplerunity_SpecCube0, u_xlat4.xyz, bias(float(u_xlat16_31)));
    ...
    u_xlat16_7.xyz = u_xlat16_1.xxx * u_xlat16_7.xyz;
    u_xlat16_1.x = u_xlat16_11 + half(1.0);
    u_xlat16_1.x = clamp(u_xlat16_1.x, 0.0h, 1.0h);
    u_xlat16_1.xyw = (-u_xlat16_8.xyz) + u_xlat16_1.xxx;
    ...
    output.SV_Target0.xyz = fma(u_xlat16_9.xyz, u_xlat16_6.xyz, u_xlat16_1.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_4.xyz = unity_Lightmap.sample(samplerunity_Lightmap, input.TEXCOORD5.xy).xyz;
    u_xlat16_6.xyz = fma(FGlobals.unity_Lightmap_HDR.xxx, u_xlat16_4.xyz, u_xlat16_12.xyz);
    u_xlat16_6.xyz = half3(u_xlat16_23) * u_xlat16_6.xyz;
    u_xlat16_3.xyz = fma(u_xlat16_6.xyz, u_xlat16_7.xyz, u_xlat16_3.xyw);
    u_xlat16_0 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD7.xy);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = half3(u_xlat16_31) * FGlobals._LightColor0.xyz;
    u_xlat16_6.xyz = half3(float3(u_xlat30) * float3(u_xlat16_6.xyz));
    u_xlat16_1.xyz = fma(u_xlat16_9.xyz, u_xlat16_6.xyz, u_xlat16_1.xyz);
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat30 = input.TEXCOORD6;
    u_xlat30 = clamp(u_xlat30, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat30), float3(u_xlat16_0.xyz), float3(FGlobals.unity_FogColor.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = fma(u_xlat16_9.xyz, u_xlat16_6.xyz, u_xlat16_3.xyz);
    u_xlat16_2.xyz = u_xlat16_3.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat32 = input.TEXCOORD6;
    u_xlat32 = clamp(u_xlat32, 0.0f, 1.0f);
    u_xlat2.xyz = fma(float3(u_xlat32), float3(u_xlat16_2.xyz), float3(FGlobals.unity_FogColor.xyz));
    output.SV_Target0.xyz = half3(u_xlat2.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat16_12.xy = _MSA.sample(sampler_MSA, input.TEXCOORD1.zw).xy;
    ...
    u_xlat16_10.xyz = fma(FGlobals._Color.xyz, u_xlat16_2.xyz, FGlobals._AddColor.xyz);
    ...
    u_xlat16_19 = fma((-u_xlat16_4.x), half(0.779083729), half(0.779083729));
    u_xlat16_5.xyz = half3(u_xlat0.xxx * float3(u_xlat16_5.xyz));
    u_xlat16_4.xyz = fma(u_xlat16_10.xyz, half3(u_xlat16_19), u_xlat16_5.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xy = _MSA.sample(sampler_MSA, input.TEXCOORD1.zw).xy;
    u_xlat16_1.xy = max(u_xlat16_2.xy, FGlobals._MinMSA.xy);
    u_xlat16_2.x = (-u_xlat16_1.y) + half(1.0);
    u_xlat16_7.x = fma(u_xlat16_2.x, u_xlat16_2.x, half(1.5));
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat15 = u_xlat15 * float(u_xlat16_7.x);
    u_xlat16_7.xyz = _BumpMap.sample(sampler_BumpMap, input.TEXCOORD1.xy).xyz;
    u_xlat16_6.xyz = fma(u_xlat16_7.xyz, half3(2.0, 2.0, 2.0), half3(-1.0, -1.0, -1.0));
    u_xlat3.x = dot(input.TEXCOORD2.xyz, float3(u_xlat16_6.xyz));
    u_xlat3.y = dot(input.TEXCOORD3.xyz, float3(u_xlat16_6.xyz));
    u_xlat3.z = dot(input.TEXCOORD4.xyz, float3(u_xlat16_6.xyz));
    u_xlat7.x = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat7.x = rsqrt(u_xlat7.x);
    u_xlat7.xyz = u_xlat7.xxx * u_xlat3.xyz;
    u_xlat0.x = dot(u_xlat7.xyz, u_xlat0.xyz);
    u_xlat0.x = clamp(u_xlat0.x, 0.0f, 1.0f);
    u_xlat5 = dot(u_xlat7.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat5 = clamp(u_xlat5, 0.0f, 1.0f);
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat16_10 = fma(u_xlat16_2.x, u_xlat16_2.x, half(-1.0));
    ...
    u_xlat16_6.xy = fma(u_xlat16_4.xy, half2(0.5, 0.5), half2(0.5, 0.5));
    u_xlat16_2.xyz = _SphereMap.sample(sampler_SphereMap, float2(u_xlat16_6.xy)).xyz;
    u_xlat16_3.xyz = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xy).xyz;
    u_xlat16_6.xyz = fma(FGlobals._Color.xyz, u_xlat16_3.xyz, FGlobals._AddColor.xyz);
    u_xlat16_6.xyz = fma(u_xlat16_2.xyz, FGlobals._SphereMapScale.xyz, u_xlat16_6.xyz);
    u_xlat16_4.xyz = u_xlat16_6.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_4.xyz = fma(u_xlat16_1.xxx, u_xlat16_4.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_1.x = fma((-u_xlat16_1.x), half(0.779083729), half(0.779083729));
    u_xlat0.xzw = u_xlat0.xxx * float3(u_xlat16_4.xyz);
    u_xlat0.xzw = fma(float3(u_xlat16_6.xyz), float3(u_xlat16_1.xxx), u_xlat0.xzw);
    u_xlat0.xzw = u_xlat0.xzw * float3(FGlobals._LightColor0.xyz);
