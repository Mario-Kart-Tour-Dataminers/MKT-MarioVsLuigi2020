    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = fma(u_xlat16_2.xyz, FGlobals._SphereMapScale.xyz, u_xlat16_7.xyz);
    ...
    u_xlat16_8.xyz = u_xlat16_0.xyz * half3(FGlobals._EmissionIntensity);
    ...
    u_xlat16_1.xyz = fma(u_xlat16_6.xyz, u_xlat16_1.xyz, u_xlat16_8.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyw = fma((-u_xlat16_7.xyz), u_xlat16_1.xxx, half3(u_xlat16_12));
    u_xlat16_1.xyz = fma(abs(half3(u_xlat16_23)), u_xlat16_1.xyw, u_xlat16_9.xyz);
    output.SV_Target0.xyz = fma(u_xlat16_6.xyz, u_xlat16_1.xyz, u_xlat16_8.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = u_xlat16_2.xyz * half3(FGlobals._EmissionIntensity);
    ...
    output.SV_Target0.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_1.xyz), float3(u_xlat16_6.xyz)));
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyw = fma((-u_xlat16_7.xyz), u_xlat16_1.xxx, half3(u_xlat16_11));
    u_xlat16_1.xyz = fma(abs(half3(u_xlat16_21)), u_xlat16_1.xyw, u_xlat16_9.xyz);
    u_xlat16_1.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_1.xyz), float3(u_xlat16_6.xyz)));
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-FGlobals.unity_FogColor.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    output.SV_Target0.xyz = fma(u_xlat16_6.xyz, u_xlat16_3.xyz, u_xlat16_8.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * FGlobals._Emission.xxyz.yzw;
    u_xlat16_5.xyz = u_xlat16_3.xyz * half3(FGlobals._EmissionIntensity);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyw = fma((-u_xlat16_7.xyz), u_xlat16_3.xxx, half3(u_xlat16_15));
    u_xlat16_3.xyz = fma(abs(half3(u_xlat16_27)), u_xlat16_3.xyw, u_xlat16_11.xyz);
    u_xlat16_3.xyz = fma(u_xlat16_6.xyz, u_xlat16_3.xyz, u_xlat16_8.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * FGlobals._Emission.xxyz.yzw;
    u_xlat16_1.xyz = u_xlat16_3.xyz * half3(FGlobals._EmissionIntensity);
    u_xlat16_32 = rint(u_xlat16_31);
    u_xlat16_31 = fma(u_xlat16_31, half(2.0), half(-1.0));
    u_xlat16_2.xyz = fma((-u_xlat16_2.xyz), half3(u_xlat16_34), half3(u_xlat16_32));
    u_xlat16_2.xyz = fma(abs(half3(u_xlat16_31)), u_xlat16_2.xyz, u_xlat16_8.xyz);
    output.SV_Target0.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_2.xyz), float3(u_xlat16_1.xyz)));
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat11.x = rsqrt(u_xlat11.x);
    u_xlat3.xyz = fma(u_xlat2.xyz, u_xlat11.xxx, float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat16_1.xy = max(u_xlat16_3.xy, FGlobals._MinMSA.xy);
    u_xlat16_23 = u_xlat16_3.z + half(-1.0);
    u_xlat16_23 = fma(FGlobals._Occlusion, u_xlat16_23, half(1.0));
    u_xlat16_23 = max(u_xlat16_23, FGlobals._MinMSA.z);
    u_xlat3.x = (-float(u_xlat16_1.y)) + 1.0;
    u_xlat14.x = fma(u_xlat3.x, u_xlat3.x, 1.5);
    u_xlat35 = u_xlat35 * u_xlat14.x;
    u_xlat16_14.xyz = _BumpMap.sample(sampler_BumpMap, input.TEXCOORD1.xy).xyz;
    u_xlat16_4.xyz = fma(u_xlat16_14.xyz, half3(2.0, 2.0, 2.0), half3(-1.0, -1.0, -1.0));
    u_xlat5.x = dot(input.TEXCOORD3.xyz, float3(u_xlat16_4.xyz));
    u_xlat5.y = dot(input.TEXCOORD4.xyz, float3(u_xlat16_4.xyz));
    u_xlat5.z = dot(input.TEXCOORD5.xyz, float3(u_xlat16_4.xyz));
    ...
    u_xlat16_34 = half(u_xlat3.x * u_xlat13);
    ...
    u_xlat16_4.xy = fma(u_xlat16_4.xy, half2(0.5, 0.5), half2(0.5, 0.5));
    u_xlat16_13.xyz = _SphereMap.sample(sampler_SphereMap, float2(u_xlat16_4.xy)).xyz;
    u_xlat16_5.xyz = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = fma(FGlobals._Color.xyz, u_xlat16_5.xyz, FGlobals._AddColor.xyz);
    u_xlat16_4.xyz = fma(u_xlat16_13.xyz, FGlobals._SphereMapScale.xyz, u_xlat16_4.xyz);
    ...
    u_xlat16_12 = u_xlat16_12 + half(1.0);
    u_xlat16_12 = clamp(u_xlat16_12, 0.0h, 1.0h);
    u_xlat16_8.xyz = (-u_xlat16_7.xyz) + half3(u_xlat16_12);
    u_xlat16_9.xyz = u_xlat16_1.xxx * u_xlat16_4.xyz;
    u_xlat2.xyz = fma(u_xlat2.xxx, float3(u_xlat16_7.xyz), float3(u_xlat16_9.xyz));
    ...
    u_xlat35 = dot(u_xlat14.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat35 = clamp(u_xlat35, 0.0f, 1.0f);
    u_xlat2.xyz = fma(u_xlat2.xyz, float3(u_xlat35), float3(u_xlat16_10.xyz));
    u_xlatb35 = u_xlat3.x<0.00499999989;
    u_xlat3.x = u_xlat3.x * 8.29800034;
    u_xlat16_12 = (u_xlatb35) ? half(0.0) : half(u_xlat3.x);
    u_xlat16_37 = dot((-u_xlat11.xyz), u_xlat14.xyz);
    u_xlat16_37 = u_xlat16_37 + u_xlat16_37;
    u_xlat16_10.xyz = half3(fma(u_xlat14.xyz, (-float3(u_xlat16_37)), (-u_xlat11.xyz)));
    ...
    u_xlat3.z = u_xlat11.x * float(u_xlat16_10.x);
    ...
    u_xlat35 = rsqrt(u_xlat35);
    u_xlat11.xyz = u_xlat11.xyz * float3(u_xlat35);
    u_xlat11.xyz = u_xlat11.xyz * float3(FGlobals._NormalDiff);
    u_xlat0.xyz = fma(u_xlat11.xyz, u_xlat0.xxx, float3(u_xlat16_10.xyz));
    u_xlat33 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat33 = rsqrt(u_xlat33);
    u_xlat0.xyz = float3(u_xlat33) * u_xlat0.xyz;
    u_xlat16_0 = unity_SpecCube0.sample(samplerunity_SpecCube0, u_xlat0.xyz, bias(float(u_xlat16_12)));
    ...
    u_xlat16_8.xyz = u_xlat16_0.xyz * half3(u_xlat16_12);
    u_xlat16_8.xyz = half3(u_xlat16_23) * u_xlat16_8.xyz;
    u_xlat16_8.xyz = half3(u_xlat16_34) * u_xlat16_8.xyz;
    u_xlat0.xyz = fma(float3(u_xlat16_8.xyz), float3(u_xlat16_7.xyz), u_xlat2.xyz);
    u_xlat16_2.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * FGlobals._Emission.xxyz.yzw;
    u_xlat16_7.xyz = u_xlat16_2.xyz * half3(FGlobals._EmissionIntensity);
    u_xlat16_12 = rint(u_xlat16_23);
    u_xlat16_23 = fma(u_xlat16_23, half(2.0), half(-1.0));
    u_xlat16_1.xyw = fma((-u_xlat16_4.xyz), u_xlat16_1.xxx, half3(u_xlat16_12));
    u_xlat16_1.xyz = fma(abs(half3(u_xlat16_23)), u_xlat16_1.xyw, u_xlat16_9.xyz);
    output.SV_Target0.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_1.xyz), float3(u_xlat16_7.xyz)));
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = u_xlat16_5.xyz * half3(FGlobals._EmissionIntensity);
    u_xlat16_3.x = rint(u_xlat16_35);
    u_xlat16_35 = fma(u_xlat16_35, half(2.0), half(-1.0));
    u_xlat16_3.xyz = fma((-u_xlat16_4.xyz), u_xlat16_25.xxx, u_xlat16_3.xxx);
    u_xlat16_3.xyz = fma(abs(half3(u_xlat16_35)), u_xlat16_3.xyz, u_xlat16_7.xyz);
    output.SV_Target0.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_3.xyz), float3(u_xlat16_2.xyz)));
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = fma((-u_xlat16_2.xyz), half3(u_xlat16_34), half3(u_xlat16_32));
    u_xlat16_2.xyz = fma(abs(half3(u_xlat16_31)), u_xlat16_2.xyz, u_xlat16_8.xyz);
    u_xlat16_1.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_2.xyz), float3(u_xlat16_1.xyz)));
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat30 = input.TEXCOORD7;
    u_xlat30 = clamp(u_xlat30, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat30), float3(u_xlat16_0.xyz), float3(FGlobals.unity_FogColor.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_15.xyz = _BumpMap.sample(sampler_BumpMap, input.TEXCOORD1.xy).xyz;
    u_xlat16_5.xyz = fma(u_xlat16_15.xyz, half3(2.0, 2.0, 2.0), half3(-1.0, -1.0, -1.0));
    u_xlat6.x = dot(input.TEXCOORD3.xyz, float3(u_xlat16_5.xyz));
    u_xlat6.y = dot(input.TEXCOORD4.xyz, float3(u_xlat16_5.xyz));
    u_xlat6.z = dot(input.TEXCOORD5.xyz, float3(u_xlat16_5.xyz));
    ...
    u_xlat16_2.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * FGlobals._Emission.xxyz.yzw;
    u_xlat16_1.xyz = u_xlat16_2.xyz * half3(FGlobals._EmissionIntensity);
    u_xlat16_16 = rint(u_xlat16_37);
    u_xlat16_37 = fma(u_xlat16_37, half(2.0), half(-1.0));
    u_xlat16_4.xyz = fma((-u_xlat16_5.xyz), u_xlat16_4.xxx, half3(u_xlat16_16));
    u_xlat16_4.xyz = fma(abs(half3(u_xlat16_37)), u_xlat16_4.xyz, u_xlat16_10.xyz);
    output.SV_Target0.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_4.xyz), float3(u_xlat16_1.xyz)));
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyw = fma((-u_xlat16_4.xyz), u_xlat16_1.xxx, half3(u_xlat16_12));
    u_xlat16_1.xyz = fma(abs(half3(u_xlat16_23)), u_xlat16_1.xyw, u_xlat16_9.xyz);
    u_xlat16_1.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_1.xyz), float3(u_xlat16_7.xyz)));
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat33 = input.TEXCOORD7;
    u_xlat33 = clamp(u_xlat33, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat33), float3(u_xlat16_0.xyz), float3(FGlobals.unity_FogColor.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = fma((-u_xlat16_4.xyz), u_xlat16_25.xxx, u_xlat16_3.xxx);
    u_xlat16_3.xyz = fma(abs(half3(u_xlat16_35)), u_xlat16_3.xyz, u_xlat16_7.xyz);
    u_xlat16_2.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_3.xyz), float3(u_xlat16_2.xyz)));
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat33 = input.TEXCOORD7;
    u_xlat33 = clamp(u_xlat33, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat33), float3(u_xlat16_0.xyz), float3(FGlobals.unity_FogColor.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_4.xyz = fma((-u_xlat16_5.xyz), u_xlat16_4.xxx, half3(u_xlat16_16));
    u_xlat16_4.xyz = fma(abs(half3(u_xlat16_37)), u_xlat16_4.xyz, u_xlat16_10.xyz);
    u_xlat16_1.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_4.xyz), float3(u_xlat16_1.xyz)));
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat36 = input.TEXCOORD7;
    u_xlat36 = clamp(u_xlat36, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat36), float3(u_xlat16_0.xyz), float3(FGlobals.unity_FogColor.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_11.xyz = fma(FGlobals._Color.xyz, u_xlat16_2.xyz, FGlobals._AddColor.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = fma(u_xlat16_2.xyz, FGlobals._SphereMapScale.xyz, u_xlat16_3.xyz);
