    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = fma(u_xlat16_4.xyz, u_xlat16_8.xyz, FGlobals._AddColor.xyz);
    ...
    u_xlat16_11.xyz = half3(float3(u_xlat36) * float3(FGlobals._LightColor0.xyz));
    ...
    u_xlat16_12 = u_xlat16_14 * u_xlat16_12;
    u_xlat16_10.xyz = fma(half3(u_xlat16_12), u_xlat16_10.xyz, u_xlat16_9.xyz);
    u_xlat16_6.xyz = u_xlat16_6.xyz * u_xlat16_10.xyz;
    u_xlat16_10.xyz = u_xlat16_2.xxx * u_xlat16_7.xyz;
    u_xlat16_9.xyz = half3(fma(u_xlat0.xxx, float3(u_xlat16_9.xyz), float3(u_xlat16_10.xyz)));
    ...
    u_xlat16_2.xyz = fma(abs(half3(u_xlat16_26)), u_xlat16_2.xyw, u_xlat16_10.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = fma(u_xlat16_2.xyz, u_xlat16_5.xyz, FGlobals._AddColor.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat40 = (u_xlatb40) ? float(u_xlat16_3.z) : (-float(u_xlat16_3.z));
    u_xlat4.z = u_xlat40 * float(u_xlat16_3.x);
    u_xlat5.x = u_xlat40 * float(u_xlat16_3.z);
    ...
    u_xlat4.xyz = u_xlat4.xyz * float3(FGlobals._NormalDiff);
    u_xlat4.xyz = fma(u_xlat4.xyz, float3(u_xlat39), float3(u_xlat16_3.xyz));
    u_xlat39 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat39 = rsqrt(u_xlat39);
    u_xlat4.xyz = float3(u_xlat39) * u_xlat4.xyz;
    u_xlat16_5.xyz = _MSA.sample(sampler_MSA, input.TEXCOORD1.xy).xyz;
    u_xlat16_3.xy = max(u_xlat16_5.xy, FGlobals._MinMSA.xy);
    u_xlat16_29 = u_xlat16_5.z + half(-1.0);
    u_xlat16_29 = fma(FGlobals._Occlusion, u_xlat16_29, half(1.0));
    u_xlat16_29 = max(u_xlat16_29, FGlobals._MinMSA.z);
    u_xlat5.z = (-float(u_xlat16_3.y)) + 1.0;
    u_xlatb39 = u_xlat5.z<0.00499999989;
    u_xlat40 = u_xlat5.z * 8.29800034;
    u_xlat16_42 = (u_xlatb39) ? half(0.0) : half(u_xlat40);
    u_xlat16_4 = unity_SpecCube0.sample(samplerunity_SpecCube0, u_xlat4.xyz, bias(float(u_xlat16_42)));
    ...
    u_xlat16_6.xyz = u_xlat16_4.xyz * half3(u_xlat16_42);
    ...
    u_xlat16_10.xyz = (-u_xlat16_9.xyz) + half3(u_xlat16_16);
    ...
    u_xlat16_13 = u_xlat16_16 * u_xlat16_13;
    u_xlat16_10.xyz = fma(half3(u_xlat16_13), u_xlat16_10.xyz, u_xlat16_9.xyz);
    u_xlat16_6.xyz = u_xlat16_6.xyz * u_xlat16_10.xyz;
    u_xlat13.x = dot(u_xlat2.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat13.x = clamp(u_xlat13.x, 0.0f, 1.0f);
    u_xlat16_10.xyz = half3(u_xlat13.xxx * float3(FGlobals._LightColor0.xyz));
    u_xlat2.w = 1.0;
    ...
    u_xlat16_11.xyz = half3(float3(u_xlat16_29) * u_xlat13.xyz);
    u_xlat16_12.xyz = u_xlat16_3.xxx * u_xlat16_7.xyz;
    u_xlat16_6.xyz = fma(u_xlat16_11.xyz, u_xlat16_12.xyz, u_xlat16_6.xyz);
    u_xlat16_9.xyz = half3(fma(u_xlat0.xxx, float3(u_xlat16_9.xyz), float3(u_xlat16_12.xyz)));
    u_xlat16_6.xyz = fma(u_xlat16_9.xyz, u_xlat16_10.xyz, u_xlat16_6.xyz);
    u_xlat16_16 = rint(u_xlat16_29);
    u_xlat16_29 = fma(u_xlat16_29, half(2.0), half(-1.0));
    u_xlat16_3.xyw = fma((-u_xlat16_7.xyz), u_xlat16_3.xxx, half3(u_xlat16_16));
    u_xlat16_3.xyz = fma(abs(half3(u_xlat16_29)), u_xlat16_3.xyw, u_xlat16_12.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = fma(u_xlat16_3.xyz, u_xlat16_4.xyz, FGlobals._AddColor.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_10.xyz = (-u_xlat16_9.xyz) + half3(u_xlat16_15);
    ...
    u_xlat16_10.xyz = half3(u_xlat16_27) * u_xlat16_1.xyz;
    u_xlat16_11.xyz = u_xlat16_3.xxx * u_xlat16_7.xyz;
    u_xlat16_6.xyz = fma(u_xlat16_10.xyz, u_xlat16_11.xyz, u_xlat16_6.xyz);
    u_xlat16_9.xyz = half3(fma(u_xlat0.xxx, float3(u_xlat16_9.xyz), float3(u_xlat16_11.xyz)));
    ...
    u_xlat16_15 = clamp(u_xlat16_15, 0.0h, 1.0h);
    u_xlat16_10.xyz = half3(u_xlat16_15) * FGlobals._LightColor0.xyz;
    u_xlat16_10.xyz = half3(float3(u_xlat12) * float3(u_xlat16_10.xyz));
    u_xlat16_6.xyz = fma(u_xlat16_9.xyz, u_xlat16_10.xyz, u_xlat16_6.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = fma(u_xlat16_0.xyz, FGlobals._SphereMapScale.xyz, u_xlat16_3.xyz);
    ...
    u_xlat16_33 = half(u_xlat26 * u_xlat36);
    ...
    u_xlat16_8.xyz = u_xlat16_3.xyz * half3(u_xlat16_34);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_13.x = u_xlat16_15 * u_xlat16_13.x;
    u_xlat16_10.xyz = fma(u_xlat16_13.xxx, u_xlat16_10.xyz, u_xlat16_9.xyz);
    u_xlat16_6.xyz = u_xlat16_6.xyz * u_xlat16_10.xyz;
    u_xlat16_13.xyz = unity_Lightmap.sample(samplerunity_Lightmap, input.TEXCOORD5.xy).xyz;
    u_xlat16_10.xyz = u_xlat16_13.xyz * FGlobals.unity_Lightmap_HDR.xxx;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = fma(u_xlat16_0.xyz, u_xlat16_1.xyz, FGlobals._AddColor.xyz);
    u_xlat0.x = FGlobals.hlslcc_mtx4x4unity_MatrixV[0].x;
    u_xlat0.y = FGlobals.hlslcc_mtx4x4unity_MatrixV[1].x;
    u_xlat0.z = FGlobals.hlslcc_mtx4x4unity_MatrixV[2].x;
    u_xlat16_1.xyz = _BumpMap.sample(sampler_BumpMap, input.TEXCOORD0.zw).xyz;
    ...
    u_xlat16_29 = u_xlat16_0.z + half(-1.0);
    u_xlat16_29 = fma(FGlobals._Occlusion, u_xlat16_29, half(1.0));
    u_xlat16_29 = max(u_xlat16_29, FGlobals._MinMSA.z);
    ...
    u_xlat1.x = rsqrt(u_xlat1.x);
    u_xlat10.xyz = fma(u_xlat5.xyz, u_xlat1.xxx, float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat32 = fma(u_xlat28, u_xlat28, -1.0);
    u_xlat10.x = fma(u_xlat10.x, u_xlat32, 1.00001001);
    u_xlat32 = fma(u_xlat19, u_xlat19, 1.5);
    ...
    u_xlat1.xyw = fma(u_xlat1.xxx, float3(u_xlat16_3.xyz), float3(u_xlat16_6.xyz));
    ...
    u_xlat1.xyw = fma(u_xlat1.xyw, float3(u_xlat32), float3(u_xlat16_8.xyz));
    u_xlatb32 = u_xlat19<0.00499999989;
    u_xlat19 = u_xlat19 * 8.29800034;
    u_xlat16_33 = (u_xlatb32) ? half(0.0) : half(u_xlat19);
    ...
    u_xlat16_13.xyz = half3(u_xlat16_29) * u_xlat16_13.xyz;
    u_xlat16_13.xyz = half3(u_xlat16_30) * u_xlat16_13.xyz;
    u_xlat0.xyz = fma(float3(u_xlat16_13.xyz), float3(u_xlat16_3.xyz), u_xlat1.xyw);
    u_xlat16_3.x = rint(u_xlat16_29);
    u_xlat16_29 = fma(u_xlat16_29, half(2.0), half(-1.0));
    u_xlat16_2.xyz = fma((-u_xlat16_2.xyz), u_xlat16_4.xxx, u_xlat16_3.xxx);
    u_xlat16_2.xyz = fma(abs(half3(u_xlat16_29)), u_xlat16_2.xyz, u_xlat16_6.xyz);
    output.SV_Target0.xyz = half3(u_xlat0.xyz * float3(u_xlat16_2.xyz));
    output.SV_Target0.w = half(1.0);
    return output;
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_10.x = dot(FGlobals.unity_SHBr, u_xlat16_1);
    u_xlat16_10.y = dot(FGlobals.unity_SHBg, u_xlat16_1);
    u_xlat16_10.z = dot(FGlobals.unity_SHBb, u_xlat16_1);
    u_xlat16_10.xyz = fma(FGlobals.unity_SHC.xyz, half3(u_xlat16_16), u_xlat16_10.xyz);
    u_xlat13.x = dot(u_xlat2.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat13.x = clamp(u_xlat13.x, 0.0f, 1.0f);
    u_xlat16_11.xyz = half3(u_xlat13.xxx * float3(FGlobals._LightColor0.xyz));
    u_xlat2.w = 1.0;
    u_xlat16_12.x = half(dot(float4(FGlobals.unity_SHAr), u_xlat2));
    u_xlat16_12.y = half(dot(float4(FGlobals.unity_SHAg), u_xlat2));
    u_xlat16_12.z = half(dot(float4(FGlobals.unity_SHAb), u_xlat2));
    ...
    u_xlat16_10.xyz = half3(fma(float3(FGlobals.unity_Lightmap_HDR.xxx), float3(u_xlat16_4.xyz), u_xlat13.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_4.xyz = fma(u_xlat16_5.xyz, u_xlat16_6.xyz, FGlobals._AddColor.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_10.xyz = u_xlat16_1.xyz * FGlobals.unity_Lightmap_HDR.xxx;
    u_xlat16_10.xyz = half3(u_xlat16_26) * u_xlat16_10.xyz;
    ...
    u_xlat16_14 = clamp(u_xlat16_14, 0.0h, 1.0h);
    u_xlat16_10.xyz = half3(u_xlat16_14) * FGlobals._LightColor0.xyz;
    u_xlat16_10.xyz = half3(float3(u_xlat36) * float3(u_xlat16_10.xyz));
    u_xlat16_6.xyz = fma(u_xlat16_9.xyz, u_xlat16_10.xyz, u_xlat16_6.xyz);
    u_xlat16_14 = rint(u_xlat16_26);
    u_xlat16_26 = fma(u_xlat16_26, half(2.0), half(-1.0));
    u_xlat16_2.xyw = fma((-u_xlat16_7.xyz), u_xlat16_2.xxx, half3(u_xlat16_14));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_10.y = dot(FGlobals.unity_SHBg, u_xlat16_1);
    u_xlat16_10.z = dot(FGlobals.unity_SHBb, u_xlat16_1);
    u_xlat16_10.xyz = fma(FGlobals.unity_SHC.xyz, half3(u_xlat16_15), u_xlat16_10.xyz);
    u_xlat12 = dot(u_xlat2.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat12 = clamp(u_xlat12, 0.0f, 1.0f);
    u_xlat2.w = 1.0;
    u_xlat16_11.x = half(dot(float4(FGlobals.unity_SHAr), u_xlat2));
    ...
    u_xlat16_10.xyz = fma(FGlobals.unity_Lightmap_HDR.xxx, u_xlat16_5.xyz, u_xlat16_4.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_11.xyz = fma(u_xlat16_1.xyz, u_xlat16_3.xyz, FGlobals._AddColor.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_18 = u_xlat16_1.z + half(-1.0);
    u_xlat16_18 = fma(FGlobals._Occlusion, u_xlat16_18, half(1.0));
    u_xlat16_18 = max(u_xlat16_18, FGlobals._MinMSA.z);
    u_xlat16_1.x = (-u_xlat16_2.y) + half(1.0);
    u_xlat16_9.x = fma(u_xlat16_1.x, u_xlat16_1.x, half(1.5));
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_1.x;
    u_xlat24 = u_xlat24 * float(u_xlat16_9.x);
    ...
    u_xlat0.x = clamp(u_xlat0.x, 0.0f, 1.0f);
    u_xlat8 = dot(u_xlat9.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat8 = clamp(u_xlat8, 0.0f, 1.0f);
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat16_16 = fma(u_xlat16_1.x, u_xlat16_1.x, half(-1.0));
    ...
    u_xlat16_10.xz = fma(u_xlat16_3.xy, half2(0.5, 0.5), half2(0.5, 0.5));
    u_xlat16_1.xyz = _SphereMap.sample(sampler_SphereMap, float2(u_xlat16_10.xz)).xyz;
    u_xlat16_4.xyz = input.COLOR0.xyz * FGlobals._Color.xyz;
    u_xlat16_5.xyz = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = fma(u_xlat16_4.xyz, u_xlat16_5.xyz, FGlobals._AddColor.xyz);
    ...
    u_xlat0.xzw = fma(u_xlat0.xxx, float3(u_xlat16_6.xyz), float3(u_xlat16_7.xyz));
    u_xlat0.xzw = u_xlat0.xzw * float3(FGlobals._LightColor0.xyz);
    u_xlat0.xyz = float3(u_xlat8) * u_xlat0.xzw;
    u_xlat16_10.x = rint(u_xlat16_18);
    u_xlat16_18 = fma(u_xlat16_18, half(2.0), half(-1.0));
    u_xlat16_2.xyw = fma((-u_xlat16_3.xyz), u_xlat16_2.xxx, u_xlat16_10.xxx);
    u_xlat16_2.xyz = fma(abs(half3(u_xlat16_18)), u_xlat16_2.xyw, u_xlat16_7.xyz);
    output.SV_Target0.xyz = half3(u_xlat0.xyz * float3(u_xlat16_2.xyz));
    output.SV_Target0.w = half(1.0);
    return output;
}
