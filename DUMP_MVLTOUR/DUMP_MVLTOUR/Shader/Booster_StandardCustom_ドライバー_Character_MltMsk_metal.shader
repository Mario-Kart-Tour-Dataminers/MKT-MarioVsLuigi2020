...
fragment Mtl_FragmentOut xlatMtlMain(
    ...
    texture2d<half, access::sample > _SphereMapMask [[ texture(4) ]] ,
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_8.xyz = fma(u_xlat16_1.xyz, u_xlat16_4.xyz, FGlobals._AddColor.xyz);
    u_xlat16_1.xyz = _SphereMapMask.sample(sampler_SphereMapMask, input.TEXCOORD1.zw).xyz;
    u_xlat16_7.xyz = fma(u_xlat16_7.xyz, u_xlat16_1.xyz, u_xlat16_8.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_8.xyz = fma(u_xlat16_11.xyz, u_xlat16_2.xyz, FGlobals._AddColor.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0.xyz = _SphereMapMask.sample(sampler_SphereMapMask, input.TEXCOORD1.zw).xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0.xyz = _SphereMapMask.sample(sampler_SphereMapMask, input.TEXCOORD1.zw).xyz;
    u_xlat16_2.xyz = fma(u_xlat16_3.xyz, u_xlat16_0.xyz, u_xlat16_2.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xy).xyz;
    u_xlat16_5.xyz = fma(u_xlat16_7.xyz, u_xlat16_1.xyz, FGlobals._AddColor.xyz);
    u_xlat16_7.xyz = _SphereMapMask.sample(sampler_SphereMapMask, input.TEXCOORD1.zw).xyz;
...
fragment Mtl_FragmentOut xlatMtlMain(
    ...
    sampler sampler_SphereMapMask [[ sampler (4) ]],
    texture2d<half, access::sample > _MainTex [[ texture(0) ]] ,
    texture2d<half, access::sample > _MSA [[ texture(1) ]] ,
    texture2d<half, access::sample > _BumpMap [[ texture(2) ]] ,
    texture2d<half, access::sample > _SphereMap [[ texture(3) ]] ,
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = u_xlat16_1.xyz * FGlobals._SphereMapScale.xyz;
    u_xlat16_1.xyz = input.COLOR0.xyz * FGlobals._Color.xyz;
    u_xlat16_4.xyz = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xy).xyz;
    u_xlat16_5.xyz = fma(u_xlat16_1.xyz, u_xlat16_4.xyz, FGlobals._AddColor.xyz);
    u_xlat16_1.xyz = _SphereMapMask.sample(sampler_SphereMapMask, input.TEXCOORD1.zw).xyz;
    u_xlat16_3.xyz = fma(u_xlat16_3.xyz, u_xlat16_1.xyz, u_xlat16_5.xyz);
