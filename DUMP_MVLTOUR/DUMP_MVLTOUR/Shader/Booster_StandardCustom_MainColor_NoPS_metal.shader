    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = fma(FGlobals._Color.xyz, half3(u_xlat16_28), u_xlat16_6.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = FGlobals._Color.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    ...
    u_xlat0.xyw = fma(float3(FGlobals._Color.xyz), float3(u_xlat16_6), u_xlat0.xyw);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = half3(u_xlat16_28) * FGlobals._Color.xyz;
    u_xlat16_28 = u_xlat16_30 + half(1.0);
    u_xlat16_28 = clamp(u_xlat16_28, 0.0h, 1.0h);
    u_xlat16_7.xyz = FGlobals._Color.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = fma(half3(FGlobals._Metallic), u_xlat16_7.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_8.xyz = half3(u_xlat16_28) + (-u_xlat16_7.xyz);
    ...
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_3.xyz = half3(fma(u_xlat0.xxx, float3(u_xlat16_7.xyz), float3(u_xlat16_6.xyz)));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = half3(u_xlat16_19) * FGlobals._Color.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = half3(u_xlat16_31) * FGlobals._Color.xyz;
    u_xlat16_31 = u_xlat16_35 + half(1.0);
    u_xlat16_31 = clamp(u_xlat16_31, 0.0h, 1.0h);
    u_xlat16_8.xyz = FGlobals._Color.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = half3(u_xlat16_35) * FGlobals._Color.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_5.xyz = half3(u_xlat16_25) * FGlobals._Color.xyz;
    ...
    u_xlat0.x = unity_NHxRoughness.sample(samplerunity_NHxRoughness, u_xlat0.xz).x;
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_5.xyz = half3(fma(u_xlat0.xxx, float3(u_xlat16_6.xyz), float3(u_xlat16_5.xyz)));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = half3(u_xlat16_22) * FGlobals._Color.xyz;
    ...
    u_xlat16_23 = dot(u_xlat16_0, FGlobals.unity_OcclusionMaskSelector);
    u_xlat16_23 = clamp(u_xlat16_23, 0.0h, 1.0h);
    u_xlat16_3.xyz = half3(u_xlat16_23) * FGlobals._LightColor0.xyz;
    u_xlat0.xyz = (-input.TEXCOORD1.xyz) + FGlobals._WorldSpaceCameraPos.xyzx.xyz;
    u_xlat21 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat21 = rsqrt(u_xlat21);
    u_xlat4.xyz = fma(u_xlat0.xyz, float3(u_xlat21), float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat21 = u_xlat21 * float(u_xlat16_5);
    ...
    u_xlat16_6.xyz = FGlobals._Color.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = fma(half3(FGlobals._Metallic), u_xlat16_6.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat4.xyz = fma(float3(u_xlat21), float3(u_xlat16_6.xyz), float3(u_xlat16_2.xyz));
    ...
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat4.xyz = fma(u_xlat4.xyz, float3(u_xlat21), float3(u_xlat16_1.xyz));
    u_xlat16_1.x = dot((-u_xlat0.xyz), input.TEXCOORD0.xyz);
    u_xlat16_1.x = u_xlat16_1.x + u_xlat16_1.x;
    u_xlat16_1.xyz = half3(fma(input.TEXCOORD0.xyz, (-float3(u_xlat16_1.xxx)), (-u_xlat0.xyz)));
    u_xlat16_0 = _HeuristicReflection.sample(sampler_HeuristicReflection, float3(u_xlat16_1.xyz));
    ...
    u_xlat16_9.xyz = half3(u_xlat16_22) + (-u_xlat16_6.xyz);
    u_xlat16_2.xyz = fma(u_xlat16_2.xxx, u_xlat16_9.xyz, u_xlat16_6.xyz);
    u_xlat0.xyz = fma(float3(u_xlat16_1.xyz), float3(u_xlat16_2.xyz), u_xlat4.xyz);
    output.SV_Target0.xyz = half3(u_xlat0.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_5.xyz = half3(u_xlat16_26) * FGlobals._Color.xyz;
    ...
    u_xlat16_2.xyz = fma(u_xlat16_7.xyz, u_xlat16_5.xyz, u_xlat16_2.xyz);
    u_xlat0.z = (-float(FGlobals._Smoothness)) + 1.0;
    u_xlat0.x = unity_NHxRoughness.sample(samplerunity_NHxRoughness, u_xlat0.xz).x;
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_5.xyz = half3(fma(u_xlat0.xxx, float3(u_xlat16_6.xyz), float3(u_xlat16_5.xyz)));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_11.xyz = FGlobals._Color.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    ...
    u_xlat16_12.xyz = u_xlat16_4.xxx * FGlobals._Color.xyz;
    u_xlat16_4.x = (-u_xlat16_4.x) + FGlobals._Smoothness;
    u_xlat16_4.x = u_xlat16_4.x + half(1.0);
    u_xlat16_4.x = clamp(u_xlat16_4.x, 0.0h, 1.0h);
    u_xlat16_5.xyz = (-u_xlat16_11.xyz) + u_xlat16_4.xxx;
    u_xlat1.xyz = fma(float3(u_xlat24), float3(u_xlat16_11.xyz), float3(u_xlat16_12.xyz));
    ...
    u_xlat16_28 = u_xlat16_28 * u_xlat16_28;
    u_xlat16_28 = u_xlat16_28 * u_xlat16_28;
    u_xlat16_11.xyz = fma(half3(u_xlat16_28), u_xlat16_5.xyz, u_xlat16_11.xyz);
    ...
    u_xlat0.xyz = fma(float3(u_xlat16_4.xyz), float3(u_xlat16_11.xyz), u_xlat1.xyz);
    output.SV_Target0.xyz = half3(u_xlat0.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = half3(u_xlat16_31) * FGlobals._Color.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = half3(u_xlat16_27) * FGlobals._Color.xyz;
    ...
    u_xlat16_2.xyz = half3(fma(u_xlat3.xxx, float3(u_xlat16_7.xyz), float3(u_xlat16_6.xyz)));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = half3(u_xlat16_21) * FGlobals._Color.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = half3(u_xlat16_30) * FGlobals._Color.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = half3(u_xlat16_41) * FGlobals._Color.xyz;
    ...
    u_xlat0.xyz = fma(u_xlat0.xxx, float3(u_xlat16_6.xyz), float3(u_xlat16_7.xyz));
    u_xlat0.xyz = u_xlat0.xyz * float3(FGlobals._LightColor0.xyz);
    u_xlat16_41 = half(input.TEXCOORD0.y * input.TEXCOORD0.y);
    u_xlat16_41 = half(fma(input.TEXCOORD0.x, input.TEXCOORD0.x, (-float(u_xlat16_41))));
    u_xlat16_2 = half4(input.TEXCOORD0.yzzx * input.TEXCOORD0.xyzz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_11.xyz = half3(u_xlat16_23) * FGlobals._Color.xyz;
    u_xlat16_23 = u_xlat16_4.x + half(1.0);
    u_xlat16_23 = clamp(u_xlat16_23, 0.0h, 1.0h);
    u_xlat16_5.xyz = FGlobals._Color.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_5.xyz = fma(half3(FGlobals._Metallic), u_xlat16_5.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    ...
    u_xlat16_2.xyz = fma(u_xlat16_6.xyz, u_xlat16_11.xyz, u_xlat16_2.xyz);
    ...
    u_xlat16_6.xyz = half3(float3(u_xlat21) * float3(u_xlat16_6.xyz));
    u_xlat0.z = (-float(FGlobals._Smoothness)) + 1.0;
    u_xlat0.x = unity_NHxRoughness.sample(samplerunity_NHxRoughness, u_xlat0.xz).x;
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_4.xyz = half3(fma(u_xlat0.xxx, float3(u_xlat16_5.xyz), float3(u_xlat16_11.xyz)));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat24 = max(u_xlat24, 0.0);
    u_xlat24 = min(u_xlat24, 100.0);
    u_xlat16_4.xyz = FGlobals._Color.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_4.xyz = fma(half3(FGlobals._Metallic), u_xlat16_4.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_28 = fma((-FGlobals._Metallic), half(0.779083729), half(0.779083729));
    u_xlat16_5.xyz = half3(u_xlat16_28) * FGlobals._Color.xyz;
    u_xlat16_28 = (-u_xlat16_28) + FGlobals._Smoothness;
    ...
    u_xlat16_7.xyz = unity_Lightmap.sample(samplerunity_Lightmap, input.TEXCOORD2.xy).xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_13.xyz = half3(u_xlat16_28) * FGlobals._Color.xyz;
    u_xlat16_28 = u_xlat16_5.x + half(1.0);
    u_xlat16_28 = clamp(u_xlat16_28, 0.0h, 1.0h);
    u_xlat16_6.xyz = FGlobals._Color.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = fma(half3(FGlobals._Metallic), u_xlat16_6.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_7.xyz = half3(u_xlat16_28) + (-u_xlat16_6.xyz);
    u_xlat16_7.xyz = fma(half3(u_xlat16_8), u_xlat16_7.xyz, u_xlat16_6.xyz);
    u_xlat16_6.xyz = half3(fma(u_xlat0.xxx, float3(u_xlat16_6.xyz), float3(u_xlat16_13.xyz)));
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat16_7.xyz;
    u_xlat16_0.xyz = unity_Lightmap.sample(samplerunity_Lightmap, input.TEXCOORD2.xy).xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_5.xyz = half3(u_xlat16_24) * FGlobals._Color.xyz;
    ...
    u_xlat16_24 = clamp(u_xlat16_24, 0.0h, 1.0h);
    u_xlat16_2.xyz = half3(u_xlat16_24) * FGlobals._LightColor0.xyz;
    u_xlat16_2.xyz = half3(float3(u_xlat27) * float3(u_xlat16_2.xyz));
    u_xlat3.z = (-float(FGlobals._Smoothness)) + 1.0;
    u_xlat3.x = unity_NHxRoughness.sample(samplerunity_NHxRoughness, u_xlat3.xz).x;
    u_xlat3.x = u_xlat3.x * 16.0;
    u_xlat16_5.xyz = half3(fma(u_xlat3.xxx, float3(u_xlat16_6.xyz), float3(u_xlat16_5.xyz)));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * half3(FGlobals._Occlusion);
    u_xlat16_24 = fma((-FGlobals._Metallic), half(0.779083729), half(0.779083729));
    u_xlat16_2.xyz = half3(u_xlat16_24) * FGlobals._Color.xyz;
    ...
    u_xlat16_10.xyz = half3(u_xlat16_24) + (-u_xlat16_7.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    output.SV_Target0.xyz = fma(u_xlat16_7.xyz, u_xlat16_2.xyz, u_xlat16_0.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_5.xyz = fma(FGlobals._Color.xyz, half3(u_xlat16_23), u_xlat16_5.xyz);
    output.SV_Target0.xyz = fma(u_xlat16_5.xyz, u_xlat16_4.xyz, u_xlat16_2.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_21 = fma(u_xlat16_21, u_xlat16_21, half(1.5));
    ...
    u_xlat16_12.x = (-u_xlat16_5) + FGlobals._Smoothness;
    ...
    u_xlat0.x = fma(u_xlat0.x, float(u_xlat16_21), 1.00001001);
    ...
    u_xlat0.xzw = fma(float3(FGlobals._Color.xyz), float3(u_xlat16_5), u_xlat0.xzw);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = half3(u_xlat16_27) * FGlobals._LightColor0.xyz;
    u_xlat16_2.xyz = half3(float3(u_xlat30) * float3(u_xlat16_2.xyz));
    u_xlat16_0.xyz = fma(u_xlat16_7.xyz, u_xlat16_2.xyz, u_xlat16_0.xyz);
    u_xlat16_3.xyz = u_xlat16_0.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat30 = input.TEXCOORD3;
    u_xlat30 = clamp(u_xlat30, 0.0f, 1.0f);
    u_xlat3.xyz = fma(float3(u_xlat30), float3(u_xlat16_3.xyz), float3(FGlobals.unity_FogColor.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_3.xyz = FGlobals._Color.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    ...
    u_xlat16_3.xyz = fma(FGlobals._Color.xyz, half3(u_xlat16_14), u_xlat16_3.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1 = (-FGlobals._Smoothness) + half(1.0);
    ...
    u_xlat0.x = max(u_xlat0.x, 0.0);
    u_xlat0.x = min(u_xlat0.x, 100.0);
    u_xlat16_2.xyz = FGlobals._Color.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    ...
    u_xlat0.xzw = fma(float3(FGlobals._Color.xyz), float3(u_xlat16_2.xxx), u_xlat0.xzw);
    u_xlat0.xzw = u_xlat0.xzw * float3(FGlobals._LightColor0.xyz);
