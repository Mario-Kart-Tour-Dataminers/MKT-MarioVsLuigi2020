    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    output.mtl_Position.z = u_xlat0.z + float(VGlobals._Offset);
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    u_xlat0 = fma(VGlobals.hlslcc_mtx4x4unity_MatrixVP[3], u_xlat0.wwww, u_xlat1);
    output.mtl_Position.xyw = u_xlat0.xyw;
    u_xlat0.x = u_xlat0.z + float(VGlobals._Offset);
    output.mtl_Position.z = u_xlat0.x;
    ...
    output.TEXCOORD0 = max(u_xlat0.x, float(u_xlat16_2));
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    Mtl_FragmentOut output;
    float4 u_xlat0;
    u_xlat0 = input.COLOR0 * float4(FGlobals._Color);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = (-FGlobals.unity_FogColor.xyz) + FGlobals._Color.xyz;
