    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = fma(u_xlat16_4.www, u_xlat16_8.xyz, u_xlat16_7.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = fma(u_xlat16_2.www, u_xlat16_8.xyz, u_xlat16_7.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    output.SV_Target0.xyz = half3(fma(float3(u_xlat16_1.xyz), float3(u_xlat16_4.xyz), u_xlat3.xyz));
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_4.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    u_xlat16_1.xyz = half3(fma(float3(u_xlat16_1.xyz), float3(u_xlat16_4.xyz), u_xlat3.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_5 = _Decal.sample(sampler_Decal, input.TEXCOORD1.zw);
    u_xlat16_5 = fma(u_xlat16_5, FGlobals._Color, FGlobals._AddColor);
    u_xlat16_7.xyz = (-u_xlat16_4.xyz) + u_xlat16_5.xyz;
    u_xlat16_4.xyz = fma(u_xlat16_5.www, u_xlat16_7.xyz, u_xlat16_4.xyz);
    ...
    u_xlat11.x = rsqrt(u_xlat11.x);
    u_xlat9.xyz = fma(u_xlat6.xyz, u_xlat11.xxx, float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat9.z = u_xlat11.x * float(u_xlat16_2.x);
    ...
    u_xlat16_2.x = (u_xlatb33) ? half(0.0) : half(u_xlat28);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = fma(u_xlat16_4.xyz, FGlobals._SphereMapScale.xyz, u_xlat16_2.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat6.xyw = fma(u_xlat6.xxx, float3(u_xlat16_4.xyz), float3(u_xlat16_7.xyz));
    u_xlat16_5 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD8.xy);
    u_xlat16_3.x = dot(u_xlat16_5, FGlobals.unity_OcclusionMaskSelector);
    u_xlat16_3.x = clamp(u_xlat16_3.x, 0.0h, 1.0h);
