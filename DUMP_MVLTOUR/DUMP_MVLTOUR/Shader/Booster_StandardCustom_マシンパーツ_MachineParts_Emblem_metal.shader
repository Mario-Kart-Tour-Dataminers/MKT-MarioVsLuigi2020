    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat32 = (u_xlatb32) ? float(u_xlat16_1.z) : (-float(u_xlat16_1.z));
    u_xlat3.z = float(u_xlat16_1.x) * u_xlat32;
    u_xlat4.x = float(u_xlat16_1.z) * u_xlat32;
    ...
    u_xlat16_3 = unity_SpecCube0.sample(samplerunity_SpecCube0, u_xlat3.xyz, bias(float(u_xlat16_31)));
    ...
    u_xlat16_5.xyz = u_xlat16_3.xyz * half3(u_xlat16_31);
    ...
    u_xlat16_6.xyz = fma(u_xlat16_3.www, u_xlat16_7.xyz, u_xlat16_6.xyz);
    ...
    u_xlat16_1.xyw = half3(u_xlat16_11) + (-u_xlat16_7.xyz);
    ...
    u_xlat16_9.xyz = half3(float3(u_xlat16_7.xyz) * u_xlat0.xxx);
    u_xlat16_6.xyz = fma(u_xlat16_6.xyz, half3(u_xlat16_21), u_xlat16_9.xyz);
    u_xlat16_21 = half((-u_xlat32) + 1.0);
    u_xlat16_0.x = u_xlat16_21 * u_xlat16_21;
    u_xlat16_0.x = u_xlat16_21 * u_xlat16_0.x;
    u_xlat16_0.x = u_xlat16_21 * u_xlat16_0.x;
    u_xlat16_1.xyz = fma(u_xlat16_0.xxx, u_xlat16_1.xyw, u_xlat16_7.xyz);
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_5.xyz;
    u_xlat16_1.xyz = fma(u_xlat16_6.xyz, u_xlat16_8.xyz, u_xlat16_1.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = fma(u_xlat16_4.www, u_xlat16_7.xyz, u_xlat16_6.xyz);
    u_xlat16_7.xyz = u_xlat16_6.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = fma(u_xlat16_1.xxx, u_xlat16_7.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = max(u_xlat16_3.xyz, FGlobals._MinMSA.xyz);
    ...
    u_xlat16_5.xyz = fma(u_xlat16_2.www, u_xlat16_6.xyz, u_xlat16_5.xyz);
    u_xlat16_31 = fma((-u_xlat16_1.x), half(0.779083729), half(0.779083729));
    u_xlat16_6.xyz = half3(u_xlat16_31) * u_xlat16_5.xyz;
    ...
    u_xlat16_1.x = dot(u_xlat16_2, FGlobals.unity_OcclusionMaskSelector);
    u_xlat16_1.x = clamp(u_xlat16_1.x, 0.0h, 1.0h);
    u_xlat16_8.xyz = u_xlat16_1.xxx * FGlobals._LightColor0.xyz;
    u_xlat3.x = input.TEXCOORD2.w;
    u_xlat3.y = input.TEXCOORD3.w;
    u_xlat3.z = input.TEXCOORD4.w;
    u_xlat9.xyz = (-u_xlat3.xyz) + FGlobals._WorldSpaceCameraPos.xyzx.xyz;
    u_xlat30 = dot(u_xlat3.xyz, FGlobals._NormalRand.xyz);
    u_xlat30 = sin(u_xlat30);
    u_xlat30 = u_xlat30 * FGlobals._NormalRand.w;
    u_xlat30 = fract(u_xlat30);
    u_xlat3.x = dot(u_xlat9.xyz, u_xlat9.xyz);
    u_xlat3.x = rsqrt(u_xlat3.x);
    u_xlat13.xyz = fma(u_xlat9.xyz, u_xlat3.xxx, float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat23 = (-float(u_xlat16_1.y)) + 1.0;
    u_xlat33 = u_xlat23 * u_xlat23;
    u_xlat39 = fma(u_xlat33, u_xlat33, -1.0);
    u_xlat13.x = fma(u_xlat13.x, u_xlat39, 1.00001001);
    u_xlat39 = fma(u_xlat23, u_xlat23, 1.5);
    u_xlat3.x = u_xlat3.x * u_xlat39;
    u_xlat3.x = u_xlat13.x * u_xlat3.x;
    u_xlat3.x = u_xlat33 / u_xlat3.x;
    u_xlat16_1.x = half(u_xlat23 * u_xlat33);
    ...
    u_xlat3.xyw = fma(u_xlat3.xxx, float3(u_xlat16_5.xyz), float3(u_xlat16_6.xyz));
    u_xlat3.xyw = float3(u_xlat16_8.xyz) * u_xlat3.xyw;
    u_xlat39 = dot(u_xlat0.xyz, float3(FGlobals._WorldSpaceLightPos0.xyz));
    u_xlat39 = clamp(u_xlat39, 0.0f, 1.0f);
    u_xlat3.xyw = fma(u_xlat3.xyw, float3(u_xlat39), float3(u_xlat16_4.xyz));
    u_xlat16_11.x = dot((-u_xlat9.xyz), u_xlat0.xyz);
    u_xlat16_11.x = u_xlat16_11.x + u_xlat16_11.x;
    u_xlat16_4.xyz = half3(fma(u_xlat0.xyz, (-float3(u_xlat16_11.xxx)), (-u_xlat9.xyz)));
    u_xlat0.x = dot(u_xlat0.xyz, u_xlat9.xyz);
    u_xlat0.x = clamp(u_xlat0.x, 0.0f, 1.0f);
    u_xlat16_11.x = half((-u_xlat0.x) + 1.0);
    u_xlat16_11.x = u_xlat16_11.x * u_xlat16_11.x;
    u_xlat16_11.x = u_xlat16_11.x * u_xlat16_11.x;
    u_xlat16_5.xyz = fma(u_xlat16_11.xxx, u_xlat16_7.xyz, u_xlat16_5.xyz);
    u_xlat0.x = dot(u_xlat16_4.zxy, (-u_xlat16_4.xyz));
    u_xlatb0 = u_xlat0.x<9.99999975e-06;
    u_xlat0.x = (u_xlatb0) ? float(u_xlat16_4.z) : (-float(u_xlat16_4.z));
    u_xlat9.z = u_xlat0.x * float(u_xlat16_4.x);
    u_xlat0.x = u_xlat0.x * float(u_xlat16_4.z);
    u_xlat9.xy = (-float2(u_xlat16_4.xy)) * float2(u_xlat16_4.yz);
    ...
    u_xlat0.xyz = fma(u_xlat0.xyz, float3(u_xlat30), float3(u_xlat16_4.xyz));
    u_xlat30 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat30 = rsqrt(u_xlat30);
    u_xlat0.xyz = float3(u_xlat30) * u_xlat0.xyz;
    u_xlatb30 = u_xlat23<0.00499999989;
    u_xlat23 = u_xlat23 * 8.29800034;
    u_xlat16_11.x = (u_xlatb30) ? half(0.0) : half(u_xlat23);
    u_xlat16_0 = unity_SpecCube0.sample(samplerunity_SpecCube0, u_xlat0.xyz, bias(float(u_xlat16_11.x)));
    ...
    u_xlat0.xyz = fma(float3(u_xlat16_1.xyz), float3(u_xlat16_5.xyz), u_xlat3.xyw);
    output.SV_Target0.xyz = half3(u_xlat0.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = fma(u_xlat16_2.www, u_xlat16_7.xyz, u_xlat16_6.xyz);
    u_xlat16_7.xyz = u_xlat16_6.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = fma(u_xlat16_1.xxx, u_xlat16_7.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    u_xlat16_1.x = fma((-u_xlat16_1.x), half(0.779083729), half(0.779083729));
    u_xlat16_6.xyz = u_xlat16_1.xxx * u_xlat16_6.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_7.xyz = half3(u_xlat4.xxx * float3(FGlobals._LightColor0.xyz));
    u_xlat1.w = 1.0;
    ...
    output.SV_Target0.xyz = fma(u_xlat16_8.xyz, u_xlat16_7.xyz, u_xlat16_2.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = fma(u_xlat16_4.www, u_xlat16_6.xyz, u_xlat16_3.xyz);
    ...
    u_xlat27 = dot(u_xlat5.xyz, FGlobals._NormalRand.xyz);
    u_xlat27 = sin(u_xlat27);
    u_xlat27 = u_xlat27 * FGlobals._NormalRand.w;
    u_xlat27 = fract(u_xlat27);
    u_xlat5.x = dot(u_xlat8.xyz, u_xlat8.xyz);
    u_xlat5.x = rsqrt(u_xlat5.x);
    u_xlat14.xyz = fma(u_xlat8.xyz, u_xlat5.xxx, float3(FGlobals._WorldSpaceLightPos0.xyz));
    ...
    u_xlat23 = (-float(u_xlat16_2.y)) + 1.0;
    u_xlat32 = u_xlat23 * u_xlat23;
    u_xlat35 = fma(u_xlat32, u_xlat32, -1.0);
    u_xlat14.x = fma(u_xlat14.x, u_xlat35, 1.00001001);
    u_xlat35 = fma(u_xlat23, u_xlat23, 1.5);
    u_xlat5.x = u_xlat5.x * u_xlat35;
    u_xlat5.x = u_xlat14.x * u_xlat5.x;
    u_xlat5.x = u_xlat32 / u_xlat5.x;
    u_xlat16_28 = half(u_xlat23 * u_xlat32);
    ...
    u_xlat5.xyw = fma(u_xlat5.xxx, float3(u_xlat16_3.xyz), float3(u_xlat16_6.xyz));
    ...
    u_xlat5.xyw = fma(u_xlat5.xyw, float3(u_xlat35), float3(u_xlat16_1.xyz));
    u_xlat16_1.x = dot((-u_xlat8.xyz), u_xlat0.xyz);
    u_xlat16_1.x = u_xlat16_1.x + u_xlat16_1.x;
    u_xlat16_1.xyz = half3(fma(u_xlat0.xyz, (-float3(u_xlat16_1.xxx)), (-u_xlat8.xyz)));
    ...
    u_xlat8.z = u_xlat0.x * float(u_xlat16_1.x);
    ...
    u_xlat23 = u_xlat23 * 8.29800034;
    u_xlat16_1.x = (u_xlatb27) ? half(0.0) : half(u_xlat23);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_5.xyz = fma(FGlobals.unity_Lightmap_HDR.xxx, u_xlat16_13.xyz, u_xlat16_1.xyz);
    u_xlat16_5.xyz = u_xlat16_2.zzz * u_xlat16_5.xyz;
    u_xlat16_2.xyz = fma(u_xlat16_5.xyz, u_xlat16_6.xyz, u_xlat16_2.xyw);
    u_xlat16_0 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD7.xy);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_6.xyz = half3(u_xlat16_31) * u_xlat16_3.xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz + half3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_3.xyz = fma(u_xlat16_2.xxx, u_xlat16_3.xyz, half3(0.220916301, 0.220916301, 0.220916301));
    ...
    u_xlat16_31 = dot(u_xlat16_4, FGlobals.unity_OcclusionMaskSelector);
    u_xlat16_31 = clamp(u_xlat16_31, 0.0h, 1.0h);
