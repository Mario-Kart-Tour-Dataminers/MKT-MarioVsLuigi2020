...
void main()
{
    ...
    u_xlat2.xyz = u_xlat4.zxy * vec3(1.0, 0.0, 0.0);
    u_xlat2.xyz = u_xlat4.yzx * vec3(0.0, 0.0, 1.0) + (-u_xlat2.xyz);
    u_xlat28 = dot(u_xlat2.xz, u_xlat2.xz);
    u_xlat28 = inversesqrt(u_xlat28);
    u_xlat2.xyz = vec3(u_xlat28) * u_xlat2.xyz;
    u_xlat28 = (-_PtclScaleRnd) * in_TEXCOORD1.x + 1.0;
    u_xlat5.xy = in_POSITION0.xy * vec2(_PtclScaleX, _PtclScaleY);
    u_xlat5.z = in_POSITION0.z;
    u_xlat5.xyz = vec3(u_xlat28) * u_xlat5.xyz;
    u_xlat6.xyz = u_xlat5.yyy * vec3(0.0, 1.0, 0.0);
    u_xlat2.xyz = u_xlat5.xxx * u_xlat2.xyz + u_xlat6.xyz;
