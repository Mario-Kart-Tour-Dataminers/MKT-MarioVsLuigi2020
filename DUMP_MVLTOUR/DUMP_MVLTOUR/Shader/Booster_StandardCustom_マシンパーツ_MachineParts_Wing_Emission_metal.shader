    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = fma(u_xlat16_5.xyz, u_xlat16_0.xyz, u_xlat16_1.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyw = fma(half3(u_xlat16_28), u_xlat16_8.xyz, u_xlat16_7.xyz);
    u_xlat2.xyz = fma(u_xlat2.xxx, float3(u_xlat16_7.xyz), float3(u_xlat16_6.xyz));
    u_xlat16_3 = unity_ShadowMask.sample(samplerunity_ShadowMask, input.TEXCOORD8.xy);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    output.SV_Target0.xyz = fma(u_xlat16_5.xyz, u_xlat16_1.xyz, u_xlat16_2.xyz);
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    output.SV_Target0.xyz = half3(fma(float3(u_xlat16_1.xyz), float3(u_xlat16_5.xyz), u_xlat0.xyz));
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = fma(u_xlat16_1.xyz, half3(1.05499995, 1.05499995, 1.05499995), half3(-0.0549999997, -0.0549999997, -0.0549999997));
    u_xlat16_1.xyz = max(u_xlat16_1.xyz, half3(0.0, 0.0, 0.0));
    u_xlat16_14.xyz = unity_Lightmap.sample(samplerunity_Lightmap, input.TEXCOORD6.xy).xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_4.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    u_xlat16_1.xyz = half3(fma(float3(u_xlat16_1.xyz), float3(u_xlat16_4.xyz), u_xlat0.xyz));
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat27 = input.TEXCOORD7;
    u_xlat27 = clamp(u_xlat27, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat27), float3(u_xlat16_0.xyz), float3(FGlobals.unity_FogColor.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_5.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_1.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    u_xlat16_2.xyz = fma(u_xlat16_5.xyz, u_xlat16_1.xyz, u_xlat16_2.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = FGlobals._Emission.xxyz.yzw * half3(FGlobals._EmissionIntensity);
    u_xlat16_5.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD2.xy).xyz;
    u_xlat16_1.xyz = half3(fma(float3(u_xlat16_1.xyz), float3(u_xlat16_5.xyz), u_xlat0.xyz));
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat30 = input.TEXCOORD7;
    u_xlat30 = clamp(u_xlat30, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat30), float3(u_xlat16_0.xyz), float3(FGlobals.unity_FogColor.xyz));
