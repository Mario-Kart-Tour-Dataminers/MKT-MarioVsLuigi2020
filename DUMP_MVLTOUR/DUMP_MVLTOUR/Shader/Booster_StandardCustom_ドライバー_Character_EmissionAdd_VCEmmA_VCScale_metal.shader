    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0.xyz = fma(input.COLOR0.xyz, FGlobals._VertexColorScale.xyz, FGlobals._Emission.xxyz.yzw);
    ...
    u_xlat16_2.xyz = fma(u_xlat16_6.xyz, u_xlat16_2.xyz, u_xlat16_8.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyw = fma((-u_xlat16_7.xyz), u_xlat16_2.xxx, half3(u_xlat16_13));
    u_xlat16_2.xyz = fma(abs(half3(u_xlat16_24)), u_xlat16_2.xyw, u_xlat16_9.xyz);
    output.SV_Target0.xyz = fma(u_xlat16_6.xyz, u_xlat16_2.xyz, u_xlat16_8.xyz);
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_1.xyz = fma(input.COLOR0.xyz, FGlobals._VertexColorScale.xyz, FGlobals._Emission.xxyz.yzw);
    u_xlat16_2.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD1.zw).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz + u_xlat16_2.xyz;
    u_xlat16_6.xyz = u_xlat16_1.xyz * half3(FGlobals._EmissionIntensity);
    ...
    output.SV_Target0.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_3.xyz), float3(u_xlat16_6.xyz)));
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyw = fma((-u_xlat16_7.xyz), u_xlat16_3.xxx, half3(u_xlat16_13));
    u_xlat16_3.xyz = fma(abs(half3(u_xlat16_23)), u_xlat16_3.xyw, u_xlat16_9.xyz);
    u_xlat16_3.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_3.xyz), float3(u_xlat16_6.xyz)));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = fma(input.COLOR0.xyz, FGlobals._VertexColorScale.xyz, FGlobals._Emission.xxyz.yzw);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = fma(input.COLOR0.xyz, FGlobals._VertexColorScale.xyz, FGlobals._Emission.xxyz.yzw);
    u_xlat16_6.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD1.zw).xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD1.zw).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz + u_xlat16_2.xyz;
    u_xlat16_7.xyz = u_xlat16_1.xyz * half3(FGlobals._EmissionIntensity);
    u_xlat16_14 = rint(u_xlat16_25);
    u_xlat16_25 = fma(u_xlat16_25, half(2.0), half(-1.0));
    ...
    output.SV_Target0.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_3.xyz), float3(u_xlat16_7.xyz)));
    output.SV_Target0.w = half(1.0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_5.xyz = fma(input.COLOR0.xyz, FGlobals._VertexColorScale.xyz, FGlobals._Emission.xxyz.yzw);
    u_xlat16_6.xyz = _EmissionMap.sample(sampler_EmissionMap, input.TEXCOORD1.zw).xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2.xyz = fma(input.COLOR0.xyz, FGlobals._VertexColorScale.xyz, FGlobals._Emission.xxyz.yzw);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyw = fma((-u_xlat16_4.xyz), u_xlat16_3.xxx, half3(u_xlat16_14));
    u_xlat16_3.xyz = fma(abs(half3(u_xlat16_25)), u_xlat16_3.xyw, u_xlat16_9.xyz);
    u_xlat16_3.xyz = half3(fma(u_xlat0.xyz, float3(u_xlat16_3.xyz), float3(u_xlat16_7.xyz)));
    u_xlat16_0.xyz = u_xlat16_3.xyz + (-FGlobals.unity_FogColor.xyz);
    u_xlat33 = input.TEXCOORD6;
    u_xlat33 = clamp(u_xlat33, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat33), float3(u_xlat16_0.xyz), float3(FGlobals.unity_FogColor.xyz));
