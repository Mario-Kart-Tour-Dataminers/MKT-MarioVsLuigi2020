    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.zw).x;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_13.xyz = _BumpMap.sample(sampler_BumpMap, input.TEXCOORD1.xy).xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat33 = clamp(u_xlat33, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat33), u_xlat0.xyz, float3(FGlobals.unity_FogColor.xyz));
    u_xlat16_1 = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.zw).x;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat36 = clamp(u_xlat36, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat36), float3(u_xlat16_0.xyz), float3(FGlobals.unity_FogColor.xyz));
    u_xlat16_4.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.zw).x;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat33 = clamp(u_xlat33, 0.0f, 1.0f);
    u_xlat0.xyz = fma(float3(u_xlat33), u_xlat0.xyz, float3(FGlobals.unity_FogColor.xyz));
    u_xlat16_5.x = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.zw).x;
    u_xlat0.w = (-float(u_xlat16_5.x)) + 1.0;
    output.SV_Target0 = half4(u_xlat0);
    return output;
}
"
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_2 = _TransparencyLM.sample(sampler_TransparencyLM, input.TEXCOORD0.zw).x;
